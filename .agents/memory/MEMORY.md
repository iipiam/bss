...
- [ZATCA credit/debit reason (KSA-10)](zatca-credit-debit-reason.md) — reason MUST be a header cbc:Note between InvoiceTypeCode and DocumentCurrencyCode, NOT in PaymentMeans; validator rejects otherwise. Recurring bug.
