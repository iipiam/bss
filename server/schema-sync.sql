...
CREATE TABLE IF NOT EXISTS "delivery_integration_alerts" (
  ...
  "active" boolean DEFAULT true NOT NULL,
  "first_detected_at" timestamp without time zone DEFAULT now() NOT NULL,
  "last_detected_at" timestamp without time zone DEFAULT now() NOT NULL,
  "resolved_at" timestamp without time zone,
  PRIMARY KEY ("id")
);
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "id" varchar DEFAULT gen_random_uuid() NOT NULL;
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "restaurant_id" varchar;
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "integration_id" varchar;
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "kind" text;
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "message" text;
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "active" boolean DEFAULT true NOT NULL;
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "first_detected_at" timestamp without time zone DEFAULT now() NOT NULL;
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "last_detected_at" timestamp without time zone DEFAULT now() NOT NULL;
ALTER TABLE "delivery_integration_alerts" ADD COLUMN IF NOT EXISTS "resolved_at" timestamp without time zone;
...
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "id" varchar DEFAULT gen_random_uuid() NOT NULL;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "restaurant_id" varchar;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "integration_id" varchar;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "provider" text;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "provider_event_id" text;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "payload_hash" text;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "raw_payload" jsonb;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "signature" text;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "status" text;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "attempts" integer DEFAULT 0 NOT NULL;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "error" text;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "order_id" varchar;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "received_at" timestamp without time zone DEFAULT now() NOT NULL;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "processed_at" timestamp without time zone;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "next_retry_at" timestamp without time zone;
ALTER TABLE "delivery_integration_events" ADD COLUMN IF NOT EXISTS "processing_started_at" timestamp without time zone;
...
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "id" varchar DEFAULT gen_random_uuid() NOT NULL;
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "restaurant_id" varchar;
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "integration_id" varchar;
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "order_id" varchar;
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "provider" text;
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "gross" numeric(12,2);
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "fee" numeric(12,2);
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "commission" numeric(12,2);
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "net" numeric(12,2);
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "source_event_id" varchar;
ALTER TABLE "delivery_integration_fees" ADD COLUMN IF NOT EXISTS "captured_at" timestamp without time zone DEFAULT now() NOT NULL;
CREATE TABLE IF NOT EXISTS "delivery_integrations" (
  ...
  "connection_status" text DEFAULT 'untested'::text NOT NULL,
...
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "id" varchar DEFAULT gen_random_uuid() NOT NULL;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "restaurant_id" varchar;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "provider" text;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "enabled" boolean DEFAULT false NOT NULL;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "credentials_encrypted" text;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "config" jsonb;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "webhook_token" text;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "connection_status" text DEFAULT 'untested'::text NOT NULL;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "connection_message" text;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "last_received_at" timestamp without time zone;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "last_success_at" timestamp without time zone;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "last_error_at" timestamp without time zone;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "last_error" text;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "created_at" timestamp without time zone DEFAULT now() NOT NULL;
ALTER TABLE "delivery_integrations" ADD COLUMN IF NOT EXISTS "updated_at" timestamp without time zone DEFAULT now() NOT NULL;
...
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "id" varchar DEFAULT gen_random_uuid() NOT NULL;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "restaurant_id" varchar;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "integration_id" varchar;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "order_id" varchar;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "status" text;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "direction" text;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "state" text;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "attempts" integer DEFAULT 0 NOT NULL;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "error" text;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "created_at" timestamp without time zone DEFAULT now() NOT NULL;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "sent_at" timestamp without time zone;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "next_retry_at" timestamp without time zone;
ALTER TABLE "delivery_status_syncs" ADD COLUMN IF NOT EXISTS "processing_started_at" timestamp without time zone;
...
CREATE TABLE IF NOT EXISTS "orders" (
  ...
  "delivery_integration_id" varchar,
  PRIMARY KEY ("id")
);
...
CREATE OR REPLACE FUNCTION delivery_order_snapshot_guard() RETURNS trigger AS $fn$ BEGIN IF EXISTS (SELECT 1 FROM delivery_integration_fees WHERE order_id=OLD.id) THEN IF TG_OP='DELETE' THEN RAISE EXCEPTION 'delivery order financial snapshot is immutable; issue a correction document'; END IF; IF NEW.items IS DISTINCT FROM OLD.items OR NEW.subtotal IS DISTINCT FROM OLD.subtotal OR NEW.tax IS DISTINCT FROM OLD.tax OR NEW.total IS DISTINCT FROM OLD.total OR NEW.delivery_integration_id IS DISTINCT FROM OLD.delivery_integration_id OR NEW.source_platform IS DISTINCT FROM OLD.source_platform OR NEW.external_order_id IS DISTINCT FROM OLD.external_order_id THEN RAISE EXCEPTION 'delivery order financial fields are immutable; issue a correction document'; END IF; END IF; IF TG_OP='DELETE' THEN RETURN OLD; END IF; RETURN NEW; END $fn$ LANGUAGE plpgsql;
...
INSERT INTO transactions (restaurant_id, transaction_id, order_id, branch_id, item_count, subtotal, tax, total, payment_method, created_at) SELECT o.restaurant_id, 'DLV-' || o.id, o.id, o.branch_id, GREATEST(jsonb_array_length(COALESCE(o.items, '[]'::jsonb)), 1), o.subtotal, o.tax, o.total, o.payment_method, o.created_at FROM orders o WHERE o.delivery_integration_id IS NOT NULL AND NOT EXISTS (SELECT 1 FROM transactions t WHERE t.restaurant_id=o.restaurant_id AND t.order_id=o.id) ON CONFLICT (transaction_id) DO NOTHING;
UPDATE transactions t SET branch_id=o.branch_id FROM orders o WHERE t.order_id=o.id AND t.restaurant_id=o.restaurant_id AND t.branch_id IS DISTINCT FROM o.branch_id;
CREATE OR REPLACE FUNCTION transaction_order_branch_guard() RETURNS trigger AS $fn$ DECLARE order_restaurant varchar; order_branch varchar; BEGIN IF NEW.order_id IS NULL THEN RETURN NEW; END IF; SELECT restaurant_id, branch_id INTO order_restaurant, order_branch FROM orders WHERE id=NEW.order_id; IF NOT FOUND THEN RAISE EXCEPTION 'transaction order does not exist'; END IF; IF NEW.restaurant_id IS DISTINCT FROM order_restaurant THEN RAISE EXCEPTION 'transaction restaurant does not match its order'; END IF; NEW.branch_id := order_branch; RETURN NEW; END $fn$ LANGUAGE plpgsql;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname='transaction_order_branch_guard') THEN CREATE TRIGGER transaction_order_branch_guard BEFORE INSERT OR UPDATE OF order_id, restaurant_id, branch_id ON transactions FOR EACH ROW EXECUTE FUNCTION transaction_order_branch_guard(); END IF; END $$;
