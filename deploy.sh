...
# Health check
# ---------------------------------------------------------------------------
# Kept sourceable so scripts/test-deploy-health-check.sh can exercise these
# operational branches with fake curl/pm2 commands and no VM side effects.
# shellcheck source=scripts/deploy-health-check.sh
source scripts/deploy-health-check.sh
