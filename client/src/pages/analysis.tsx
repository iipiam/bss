        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between gap-2 pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                Total Revenue
                <InfoTip>Gross sales across all branches for the period.</InfoTip>
              </CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between gap-2 pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                Total Costs
                <InfoTip>Sum of all operating expenses for the period.</InfoTip>
              </CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between gap-2 pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                Net Profit
                <InfoTip>Revenue minus total costs.</InfoTip>
              </CardTitle>
              <DollarSign className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between gap-2 pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">
                Efficiency Score
                <InfoTip>Composite score of operational performance across branches.</InfoTip>
              </CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  ...
                  <InfoTip>Profit percentage per menu category (revenue minus cost).</InfoTip>
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  ...
                  <InfoTip>Distribution of operating expenses by category.</InfoTip>
                </CardTitle>
              </CardHeader>
              <CardContent>
                    ...
                    <CardTitle className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-sm text-muted-foreground">
                          Efficiency:
                          <InfoTip>Operational efficiency score for this branch.</InfoTip>
                        </span>
