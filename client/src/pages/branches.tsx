                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Status
                          <InfoTip>{isRTL ? "حدد ما إذا كان الفرع نشطًا أو غير نشط حاليًا." : "Set whether this branch is currently active or inactive."}</InfoTip>
                        </FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Location
                        <InfoTip>{isRTL ? "العنوان أو المدينة التي يقع فيها هذا الفرع." : "Street address or city where this branch is located."}</InfoTip>
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Manager
                          <InfoTip>{isRTL ? "اسم الشخص المسؤول عن إدارة هذا الفرع." : "Name of the person responsible for running this branch."}</InfoTip>
                        </FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        Staff Count
                        <InfoTip>{isRTL ? "إجمالي عدد الموظفين العاملين في هذا الفرع." : "Total number of employees working at this branch."}</InfoTip>
                      </FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                  ...
                  <Card className="bg-muted/50">
                    <CardContent className="p-4">
                      <p className="text-sm text-muted-foreground mb-1">
                        Today's Sales
                        <InfoTip>{isRTL ? "إجمالي إيرادات المبيعات لهذا الفرع اليوم." : "Total sales revenue generated by this branch today."}</InfoTip>
                      </p>
                ...
                <div>
                  <Card className="bg-muted/50">
                    <CardContent className="p-4">
                      <p className="text-sm text-muted-foreground mb-1">
                        Today's Orders
                        <InfoTip>{isRTL ? "عدد الطلبات المعالجة في هذا الفرع اليوم." : "Number of orders processed at this branch today."}</InfoTip>
                      </p>
                      <p className="text-2xl font-bold font-mono">-</p>
                    </CardContent>
                  </Card>
