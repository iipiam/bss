...
> = {
  ...
  real_estate: {
    ...
    7: {
      ...
      description: "Track commissions earned from sales and rentals, broken down by office, agent and period.",
    },
    11: {
      title: "Valuations & Property Reports",
      description: "Generate rent roll, occupancy, income statement, cash flow and aging reports for your portfolio.",
    },
  },
  design_services: {
    4: {
...
const realEstateExtras: ExtraTutorial[] = [
  {
    ...
    description: "Create properties and the units inside them (apartments, villas, offices) with size, pricing and availability.",
    ...
    steps: [
      { title: "Open Properties", description: "Go to Property Management → Properties in the sidebar." },
      { title: "Add a Property", description: "Click 'Add Property', enter address, property type (residential/commercial/mixed) and total size." },
      { title: "Add Units", description: "Open the property and add each rentable unit with unit number, type, size and base rent." },
      { title: "Upload Photos", description: "Attach high-quality photos for the listing and individual units.", tips: ["Hero image first", "Show every room"] },
      { title: "Set Availability", description: "Toggle each unit as available, occupied or under maintenance.", tips: ["Status drives occupancy reports automatically"] },
      { title: "Switch View", description: "Use the grid/list toggle in the top-right to switch between card and table views." },
    ],
  },
  {
    title: "Tenants",
    description: "Maintain your tenant database with contact details, ID documents and contract history.",
    ...
    _businessTypes: ["real_estate"],
    steps: [
      { title: "Open Tenants", description: "Go to Property Management → Tenants in the sidebar." },
      { title: "Add a Tenant", description: "Click 'Add Tenant' and capture full name, national ID, phone, email and emergency contact." },
      { title: "Attach Documents", description: "Upload copies of ID and any supporting documents required by your office policy." },
      { title: "Review Contracts", description: "Open a tenant to see all their past and current rental contracts in one place." },
    ],
  },
  {
    title: "Rental Contracts",
    description: "Create rental contracts that auto-generate invoices and post double-entry journal entries.",
    ...
    _businessTypes: ["real_estate"],
    steps: [
      { title: "Open Contracts", description: "Go to Property Management → Contracts." },
      { title: "Create a Contract", description: "Click 'New Contract', pick the unit and tenant, set start/end dates, monthly rent and security deposit." },
      { title: "Choose Billing Cycle", description: "Select monthly, quarterly or annual billing — invoices will be auto-generated on this cadence." },
      { title: "Enable Auto-Renew (optional)", description: "Turn on auto-renew so the contract rolls forward automatically before expiry.", tips: ["You'll still get a 30-day expiry notification before renewal"] },
      { title: "Activate", description: "Set status to Active. The system creates the schedule of rental invoices and posts the opening journal entry." },
      { title: "Download PDF", description: "Use the PDF button to download a bilingual signed contract for the tenant." },
    ],
  },
  {
    title: "Rental Invoices & Payments",
    description: "Issue rental invoices, record payments and reconcile receivables — all double-entry posted.",
    ...
    _businessTypes: ["real_estate"],
    steps: [
      { title: "Open Invoices", description: "Go to Property Management → Invoices to see all rental invoices for your portfolio." },
      { title: "Filter Overdue", description: "Use the status filter to focus on Overdue invoices. The daily sweep marks them automatically." },
      { title: "Record a Payment", description: "Open an invoice and click 'Record Payment'. Enter the amount, method (cash/bank/card) and reference." },
      { title: "Download Receipt", description: "Use the receipt button on the payment to download a bilingual PDF receipt for the tenant." },
      { title: "Reconcile in Accounting", description: "Open Accounting → Journal to see the matched debit/credit lines for each invoice and payment." },
    ],
  },
  {
    title: "Maintenance Requests",
    description: "Log maintenance tickets per unit, assign them and track resolution time.",
    estimatedTime: "4 minutes",
    icon: Wrench,
    image: inquiryImg,
    screenshot: inquiryImg,
    ...
    _businessTypes: ["real_estate"],
    steps: [
      { title: "Open Maintenance", description: "Go to Property Management → Maintenance." },
      { title: "Create a Request", description: "Click 'New Request', link the unit, describe the issue and set priority (low/medium/high/urgent)." },
      { title: "Assign", description: "Assign to an office employee or external vendor and set an expected completion date." },
      { title: "Update Status", description: "Move the request through Open → In Progress → Completed and log actual cost on close.", tips: ["Costs auto-flow into property expenses"] },
    ],
  },
  {
    title: "Accounting (Journal & Chart of Accounts)",
    description: "Review your standard chart of accounts and every auto-posted journal entry for rentals, expenses and payments.",
    estimatedTime: "6 minutes",
    icon: BookOpen,
    ...
    _businessTypes: ["real_estate"],
    steps: [
      { title: "Open Accounting", description: "Go to Property Management → Accounting." },
      { title: "Seed Chart of Accounts", description: "On a new account, click 'Ensure Standard Accounts' to install the default real-estate chart (rent income, security deposit liability, maintenance expense, etc.)." },
      { title: "Browse Journal Entries", description: "Open the Journal tab. Every contract activation, invoice and payment creates a balanced debit/credit entry." },
      { title: "Download Entry PDF", description: "Use the download icon on any journal row to export a single entry as a PDF for audit purposes." },
      { title: "Export Trial Balance", description: "From the Trial Balance tab, export PDF or Excel for your accountant.", tips: ["Excel keeps formulas-friendly numeric formatting"] },
    ],
  },
];
