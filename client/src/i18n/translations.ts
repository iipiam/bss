...
// Shop
  ...
  Italian: {
    ...
    phone: 'Telefono',
    email: 'Email',
    welcomeMessage: 'Benvenuto nel nostro sistema di supporto',
    ...
    viewAllCustomers: 'Visualizza Tutti i Clienti',
    viewReports: 'Visualizza Report',
    
    // Branches
    addBranch: 'Aggiungi Filiale',
    editBranch: 'Modifica Filiale',
    deleteBranch: 'Elimina Filiale',
    branchName: 'Nome Filiale',
    branchAddress: 'Indirizzo Filiale',
    branchPhone: 'Telefono Filiale',
    branchManager: 'Responsabile Filiale',
    allBranches: 'Tutte le Filiali',
    selectBranch: 'Seleziona Filiale',
    
    // Inventory
    addInventoryItem: 'Aggiungi Articolo Inventario',
    editInventoryItem: 'Modifica Articolo Inventario',
    deleteInventoryItem: 'Elimina Articolo Inventario',
    ...
    deleteMenuItem: 'Elimina Articolo Menu',
    menuName: 'Nome Menu',
    menuCategory: 'Categoria Menu',
    menuPrice: 'Prezzo Menu',
    menuDescription: 'Descrizione Menu',
    ...
    markAsServed: 'Segna come Servito',
    tableName: 'Nome Tavolo',
    tableNumber: 'Numero Tavolo',
    waitingTime: 'Tempo di Attesa',
    preparationStatus: 'Stato Preparazione',
    
    // Procurement
    addProcurement: 'Aggiungi Approvvigionamento',
    editProcurement: 'Modifica Approvvigionamento',
    deleteProcurement: 'Elimina Approvvigionamento',
    purchaseOrder: 'Ordine di Acquisto',
    purchaseDate: 'Data Acquisto',
    supplierName: 'Nome Fornitore',
    supplierContact: 'Contatto Fornitore',
    purchaseItems: 'Articoli Acquistati',
    purchaseTotal: 'Totale Acquisto',
    ...
    yearlySales: 'Vendite Annuali',
    salesByCategory: 'Vendite per Categoria',
    salesByItem: 'Vendite per Articolo',
    salesByBranch: 'Vendite per Filiale',
    ...
    // Profitability
    profitabilityReport: 'Report Redditività',
    profitByItem: 'Profitto per Articolo',
    profitByCategory: 'Profitto per Categoria',
    profitByBranch: 'Profitto per Filiale',
    mostProfitableItems: 'Articoli Più Redditizi',
    leastProfitableItems: 'Articoli Meno Redditizi',
    profitTrend: 'Tendenza Profitto',
    ...
    employeePhone: 'Telefono Dipendente',
    employeeEmail: 'Email Dipendente',
    employeeRole: 'Ruolo Dipendente',
    employeeSalary: 'Stipendio Dipendente',
    employeeStatus: 'Stato Dipendente',
    ...
    businessAddress: 'Indirizzo Attività',
    businessPhone: 'Telefono Attività',
    businessEmail: 'Email Attività',
    businessLogo: 'Logo Attività',
    currency: 'Valuta',
    language: 'Lingua',
    ...
    simplifiedInvoice: 'Fattura Semplificata',
  ...
  Spanish: {
    ...
    deleteMenuItem: 'Eliminar Artículo de Menú',
    menuName: 'Nombre del Menú',
    menuCategory: 'Categoría del Menú',
    menuPrice: 'Precio del Menú',
    ...
    // Procurement
    addProcurement: 'Añadir Adquisición',
    editProcurement: 'Editar Adquisición',
    deleteProcurement: 'Eliminar Adquisición',
    purchaseOrder: 'Orden de Compra',
    purchaseDate: 'Fecha de Compra',
    supplierName: 'Nombre del Proveedor',
    supplierContact: 'Contacto del Proveedor',
    purchaseItems: 'Artículos Comprados',
    ...
    salesByBranch: 'Ventas por Sucursal',
    ...
    // Profitability
    profitabilityReport: 'Informe de Rentabilidad',
    profitByItem: 'Ganancia por Artículo',
    profitByCategory: 'Ganancia por Categoría',
    profitByBranch: 'Ganancia por Sucursal',
    mostProfitableItems: 'Artículos Más Rentables',
    leastProfitableItems: 'Artículos Menos Rentables',
    profitTrend: 'Tendencia de Ganancia',
    ...
    employeePhone: 'Teléfono del Empleado',
    ...
    deleteSuccess: 'Eliminado exitoso',
    updateSuccess: 'Actualizado exitoso',
    ...
    // ZATCA Compliance
    zatcaCompliant: 'Conforme a ZATCA',
    qrCode: 'Código QR',
    bilingual: 'Bilingüe',
    ...
    // Device Preferences
    devicePreferences: 'Preferencias de Dispositivo',
    ...
    valueTooLow: 'Valor muy bajo',
    valueTooHigh: 'Valor muy alto',
  ...
  Tagalog: {
    ...
    phone: 'Telepono',
    email: 'Email',
    welcomeMessage: 'Maligayang pagdating sa aming sistema ng suporta',
    howCanWeHelp: 'Paano ka namin matutulungan ngayon?',
    ...
    deselectAll: 'Alisin ang Pagpili sa Lahat',
    ...
    totalProfit: 'Kabuuang Tubo',
    totalCustomers: 'Kabuuang Mga Customer',
    recentOrders: 'Kamakailang Mga Order',
    topSellingItems: 'Pinakamabentang Produkto',
    lowStockItems: 'Kaunting Stock',
    quickActions: 'Mabilisang Aksyon',
    viewAllOrders: 'Tingnan Lahat ng Order',
    viewAllCustomers: 'Tingnan Lahat ng Customer',
    viewReports: 'Tingnan ang Mga Ulat',
    
    // Branches
    addBranch: 'Magdagdag ng Sangay',
    editBranch: 'I-edit ang Sangay',
    deleteBranch: 'Tanggalin ang Sangay',
    branchName: 'Pangalan ng Sangay',
    branchAddress: 'Address ng Sangay',
    branchPhone: 'Telepono ng Sangay',
    branchManager: 'Manager ng Sangay',
    allBranches: 'Lahat ng Sangay',
    selectBranch: 'Pumili ng Sangay',
    
    // Inventory
    addInventoryItem: 'Magdagdag ng Item sa Imbentaryo',
    editInventoryItem: 'I-edit ang Item sa Imbentaryo',
    deleteInventoryItem: 'Tanggalin ang Item sa Imbentaryo',
    itemName: 'Pangalan ng Item',
    itemCode: 'Code ng Item',
    itemCategory: 'Kategorya ng Item',
    currentStock: 'Kasalukuyang Stock',
    minimumStock: 'Minimum na Stock',
    unit: 'Yunit',
    costPrice: 'Presyo ng Pagbili',
    sellingPrice: 'Presyo ng Pagbebenta',
    supplier: 'Supplier',
    expiryDate: 'Petsa ng Pag-expire',
    stockValue: 'Halaga ng Stock',
    stockAlert: 'Babala sa Stock',
    outOfStock: 'Ubos na',
    ...
    deleteMenuItem: 'Tanggalin ang Item sa Menu',
    menuName: 'Pangalan ng Menu',
    menuCategory: 'Kategorya ng Menu',
    menuPrice: 'Presyo ng Menu',
    menuDescription: 'Paglalarawan ng Menu',
    available: 'Available',
    ...
    // Recipes
    addRecipe: 'Magdagdag ng Resipe',
    editRecipe: 'I-edit ang Resipe',
    deleteRecipe: 'Tanggalin ang Resipe',
    recipeName: 'Pangalan ng Resipe',
    ingredients: 'Mga Sangkap',
    ingredient: 'Sangkap',
    addIngredient: 'Magdagdag ng Sangkap',
    removeIngredient: 'Tanggalin ang Sangkap',
    preparationTime: 'Oras ng Paghahanda',
    cookingTime: 'Oras ng Pagluluto',
    servings: 'Mga Serving',
    instructions: 'Mga Tagubilin',
    recipeCost: 'Gastos ng Resipe',
    ...
    customerAddress: 'Address ng Customer',
    customerType: 'Uri ng Customer',
    loyaltyPoints: 'Loyalty Points',
    totalSpent: 'Kabuuang Ginastos',
    lastVisit: 'Huling Pagbisita',
    customerSince: 'Customer Simula',
    regular: 'Regular',
    vip: 'VIP',
    new: 'Bago',
    
    // Orders
    addOrder: 'Magdagdag ng Order',
    editOrder: 'I-edit ang Order',
    deleteOrder: 'Tanggalin ang Order',
    ...
    partiallyPaid: 'Bahagyang Bayad',
    
    // Kitchen
    kitchenDisplay: 'Display ng Kusina',
    newOrders: 'Mga Bagong Order',
    inProgress: 'Ginagawa',
    ready: 'Handa Na',
    served: 'Naihain Na',
    orderReady: 'Handa na ang Order',
    markAsReady: 'Markahan bilang Handa',
    markAsServed: 'Markahan bilang Naihain',
    tableName: 'Pangalan ng Mesa',
    tableNumber: 'Numero ng Mesa',
    waitingTime: 'Oras ng Paghihintay',
    preparationStatus: 'Katayuan ng Paghahanda',
    
    // Procurement
    addProcurement: 'Magdagdag ng Pagbili',
    editProcurement: 'I-edit ang Pagbili',
    deleteProcurement: 'Tanggalin ang Pagbili',
    purchaseOrder: 'Purchase Order',
    purchaseDate: 'Petsa ng Pagbili',
    supplierName: 'Pangalan ng Supplier',
    supplierContact: 'Contact ng Supplier',
    purchaseItems: 'Mga Biniling Item',
    purchaseTotal: 'Kabuuang Binili',
    receivedDate: 'Petsa ng Pagtanggap',
    received: 'Natanggap',
    notReceived: 'Hindi Pa Natanggap',
    
    // Sales
    salesReport: 'Ulat ng Benta',
    dailySales: 'Arawang Benta',
    weeklySales: 'Lingguhang Benta',
    monthlySales: 'Buwanang Benta',
    yearlySales: 'Taunang Benta',
    salesByCategory: 'Benta ayon sa Kategorya',
    salesByItem: 'Benta ayon sa Item',
    salesByBranch: 'Benta ayon sa Sangay',
    salesByEmployee: 'Benta ayon sa Empleyado',
    totalSales: 'Kabuuang Benta',
    grossSales: 'Gross Sales',
    netSales: 'Net Sales',
    
    // Financial
    financialReport: 'Ulat Pinansyal',
    income: 'Kita',
    expense: 'Gastos',
    profit: 'Tubo',
    loss: 'Lugi',
    revenue: 'Kita',
    costOfGoodsSold: 'Gastos ng Ibinenta',
    grossProfit: 'Gross Profit',
    netProfit: 'Net Profit',
    operatingExpenses: 'Gastos sa Operasyon',
    profitMargin: 'Margin ng Tubo',
    
    // Profitability
    profitabilityReport: 'Ulat ng Kita',
    profitByItem: 'Tubo ayon sa Item',
    profitByCategory: 'Tubo ayon sa Kategorya',
    profitByBranch: 'Tubo ayon sa Sangay',
    mostProfitableItems: 'Pinakakumikitang Item',
    leastProfitableItems: 'Pinakamababang Kita na Item',
    profitTrend: 'Trend ng Tubo',
    
    // Invoices
    addInvoice: 'Magdagdag ng Resibo',
    editInvoice: 'I-edit ang Resibo',
    deleteInvoice: 'Tanggalin ang Resibo',
    invoiceNumber: 'Numero ng Resibo',
    invoiceDate: 'Petsa ng Resibo',
    dueDate: 'Petsa ng Deadline',
    invoiceItems: 'Mga Item sa Resibo',
    invoiceTotal: 'Kabuuan ng Resibo',
    invoiceStatus: 'Katayuan ng Resibo',
    generateInvoice: 'Gumawa ng Resibo',
    printInvoice: 'I-print ang Resibo',
    sendInvoice: 'Ipadala ang Resibo',
    downloadInvoice: 'I-download ang Resibo',
    ...
    employeePhone: 'Telepono ng Empleyado',
    employeeEmail: 'Email ng Empleyado',
    employeeRole: 'Tungkulin ng Empleyado',
    employeeSalary: 'Sahod ng Empleyado',
    employeeStatus: 'Katayuan ng Empleyado',
    ...
    taxSettings: 'Mga Setting ng Buwis',
    ...
    invalidPhone: 'Hindi wastong telepono',
    ...
    updateError: 'May error sa pag-update',
    createError: 'May error sa paggawa',
    networkError: 'May error sa network',
    serverError: 'May error sa server',
    
    // Confirmation Messages
    confirmDelete: 'Sigurado ka bang gusto mong tanggalin?',
    confirmCancel: 'Sigurado ka bang gusto mong kanselahin?',
    confirmLogout: 'Sigurado ka bang gusto mong mag-logout?',
    unsavedChanges: 'May mga pagbabagong hindi pa na-save',
    ...
    newNotification: 'Bagong Notification',
    ...
    selectBusinessType: 'Pumili ng Uri ng Negosyo',
    
    // Factory Specific
    production: 'Produksyon',
    productionLine: 'Linya ng Produksyon',
    rawMaterials: 'Hilaw na Materyales',
    finishedGoods: 'Tapos na Produkto',
    qualityControl: 'Kontrol ng Kalidad',
    ...
    taxInvoice: 'Resibo ng Buwis',
    simplifiedInvoice: 'Pinasimpleng Resibo',
    ...
    // Device Preferences
    devicePreferences: 'Mga Kagustuhan ng Device',
    defaultView: 'Default na View',
    displayMode: 'Mode ng Display',
    ...
    requiredFields: 'Mga kinakailangang field',
    invalidFormat: 'Hindi wastong format',
    valueTooLow: 'Masyadong mababa ang halaga',
    valueTooHigh: 'Masyadong mataas ang halaga',
    
    // More success messages
    operationSuccess: 'Matagumpay na operasyon',
    dataExported: 'Na-export ang datos',
    dataImported: 'Na-import ang datos',
    settingsSaved: 'Na-save ang mga setting',
    
    // More error messages
    operationFailed: 'Nabigo ang operasyon',
    dataNotFound: 'Hindi nahanap ang datos',
    accessDenied: 'Access ay tinanggihan',
    sessionExpired: 'Nag-expire ang session',
    
    // Pagination
    page: 'Pahina',
    rowsPerPage: 'Mga row bawat pahina',
    of: 'ng',
