...
export interface Translations {
  ...
  inventoryForecast: string;
  inventoryForecastDesc: string;
  noInventoryData: string;
  linkRecipesToMenuItems: string;
  criticalStock: string;
  needsImmediateReorder: string;
  reorderSoon: string;
  ...
  doYouHaveVatRegistration: string;
  selectVatRegistrationStatus: string;
  taxNumberRequired: string;
  vatCertificateRequired: string;
  uploadBusinessDocumentsDesc: string;
  crCertificateRequired: string;
  ibanCertificateRequired: string;
  nationalAddressRequired: string;
  uploadBusinessDocumentsRequiredDesc: string;
  ...
  accountCreatedWithUsername: string;
  anErrorOccurredDuringSignup: string;
  paymentNotCompleted: string;
  paymentStillPending: string;
  signupSessionExpired: string;
  accountCouldNotBeCreated: string;
  paymentProcessingError: string;
  paymentVerificationFailed: string;
  redirectingToPayment: string;
  pleaseCompleteSubscriptionPayment: string;
  itAccountCreated: string;
  itAccountCreatedDesc: string;
  failedToCreateItAccount: string;
  pleaseIncludeSecretKey: string;
  ...
  statementPreviewFailed: string;
  previewStatementDesc: string;
  investorType: string;
  ...
  ibanCertUploaded: string;
  ibanCertUploadedDesc: string;
  failedToUploadIbanCert: string;
  ibanCertDeleted: string;
  ibanCertDeletedDesc: string;
  failedToDeleteIbanCert: string;
  ibanCertPreviewFailed: string;
  ibanCertDownloadFailed: string;
  previewIbanCert: string;
  downloadIbanCert: string;
  uploadIbanCert: string;
  confirmDeleteIbanCert: string;
  confirmDeleteIbanCertDesc: string;
  addSalary: string;
  editSalary: string;
  ...
  // Procurement Page Keys
  procurementManagement: string;
  procurementDescription: string;
  editProcurement: string;
  newProcurementRequest: string;
  newRequest: string;
  installation: string;
  priority: string;
  high: string;
  linkToExistingInventory: string;
  createNewInventoryItem: string;
  title: string;
  enterTitle: string;
  totalCost: string;
  requestedBy: string;
  ...
  deleteProcurementConfirm: string;
  noProcurementFound: string;
  failedToCreateProcurement: string;
  failedToUpdateProcurement: string;
  failedToDeleteProcurement: string;
  failedToReorderProcurement: string;
  failedToSyncInventory: string;
  failedToSyncShopBills: string;
  shopBillsSynced: string;
  inventorySynced: string;
  dragDropOrClickToUpload: string;
  supportedFileTypes: string;
  automaticallyCalculated: string;
  totalPriceForEntireStock: string;
  ...
  projectUpdatedDesc: string;
  projectDeleted: string;
  projectDeletedDesc: string;
  ...
  medium: string;
  high: string;
  updateProjectInfo: string;
  addNewProject: string;
  deleteProjectConfirm: string;
  
  // Quotations
  quotationsPage: string;
  quotationsDescription: string;
  addQuotation: string;
  editQuotation: string;
  deleteQuotation: string;
  quotationCreated: string;
  quotationCreatedDesc: string;
  quotationUpdated: string;
  quotationUpdatedDesc: string;
  quotationDeleted: string;
  quotationDeletedDesc: string;
  failedToCreateQuotation: string;
  failedToUpdateQuotation: string;
  failedToDeleteQuotation: string;
  ...
  noQuotationsFound: string;
  noQuotationsYet: string;
  addFirstQuotation: string;
  sent: string;
  declined: string;
  vatRate: string;
  totalAmount: string;
  updateQuotationInfo: string;
  addNewQuotation: string;
  deleteQuotationConfirm: string;
  
  // Service Catalog
  serviceCatalogPage: string;
  serviceCatalogDescription: string;
  addService: string;
  editService: string;
  deleteService: string;
  serviceCreated: string;
  serviceCreatedDesc: string;
  serviceUpdated: string;
  serviceUpdatedDesc: string;
  serviceDeleted: string;
  serviceDeletedDesc: string;
  ...
  updateServiceInfo: string;
  addNewService: string;
  deleteServiceConfirm: string;
  
  // Contractors
  contractorsPage: string;
  contractorsDescription: string;
  addContractor: string;
  editContractor: string;
  deleteContractor: string;
  contractorCreated: string;
  contractorCreatedDesc: string;
  contractorUpdated: string;
  contractorUpdatedDesc: string;
  contractorDeleted: string;
  contractorDeletedDesc: string;
  failedToCreateContractor: string;
  failedToUpdateContractor: string;
  failedToDeleteContractor: string;
  ...
  noContractorsFound: string;
  noContractorsYet: string;
  addFirstContractor: string;
  updateContractorInfo: string;
  addNewContractor: string;
  deleteContractorConfirm: string;
}
...
export const translations: Record<Language, Translations> = {
  English: {
    ...
    inventoryForecastDesc: 'Predicted inventory requirements based on sales forecast',
    noInventoryData: 'No inventory data available',
    linkRecipesToMenuItems: 'Link recipes to menu items to see inventory forecasts',
    criticalStock: 'Critical Stock',
    needsImmediateReorder: 'Needs immediate reorder',
    reorderSoon: 'Consider reordering soon',
    sufficientStock: 'Sufficient Stock',
    stockLevelOk: 'Stock levels are adequate',
    ...
    showingTopInventory: 'Showing top {count} inventory items by shortfall',
    ...
    weeklyScheduleDesc: 'Configure operating hours for each day of the week',
    ...
    doYouHaveVatRegistration: 'Do you have VAT Registration?',
    selectVatRegistrationStatus: 'Please select whether you have VAT registration',
    taxNumberRequired: 'Tax Number is required when you have VAT registration',
    vatCertificateRequired: 'VAT Certificate is required when you have VAT registration',
    uploadBusinessDocumentsDesc: 'Upload your business documents (optional, PDF only)',
    crCertificateRequired: 'CR Certificate is required',
    ibanCertificateRequired: 'IBAN Certificate is required',
    nationalAddressRequired: 'National Address certificate is required',
    uploadBusinessDocumentsRequiredDesc: 'Upload your business documents (PDF only, max 10MB each)',
    ...
    accountCreatedWithUsername: 'Your account "{username}" has been created. Please sign in.',
    anErrorOccurredDuringSignup: 'An error occurred during signup.',
    paymentNotCompleted: 'Payment was not completed. Please try again.',
    paymentStillPending: 'Payment is still pending. Please try again.',
    signupSessionExpired: 'Signup session expired. Please try again.',
    accountCouldNotBeCreated: 'Account could not be created. Please contact support.',
    paymentProcessingError: 'Payment processing error. Please try again.',
    paymentVerificationFailed: 'Payment verification failed. Please contact support if payment was deducted.',
    redirectingToPayment: 'Redirecting to Payment',
    pleaseCompleteSubscriptionPayment: 'Please complete your subscription payment of {amount} SAR',
    ...
    failedToCreateItAccount: 'Failed to create IT account',
    pleaseIncludeSecretKey: 'Please fill in all fields including the secret key',
    ...
    investorNationalId: 'ID (National/Iqama)',
    enterNationalId: 'Enter ID number',
    investorContactNumber: 'Contact Number',
    ...
    statementPreviewFailed: 'Preview Failed',
    previewStatementDesc: 'Preview the investor statement PDF below',
    ...
    ibanHelp: 'Saudi IBAN format: SA followed by 22 digits',
    ibanCertificate: 'IBAN Certificate',
    ibanCertUploaded: 'IBAN Certificate Uploaded',
    ibanCertUploadedDesc: 'IBAN certificate has been uploaded successfully.',
    failedToUploadIbanCert: 'Failed to Upload IBAN Certificate',
    ibanCertDeleted: 'IBAN Certificate Deleted',
    ibanCertDeletedDesc: 'IBAN certificate has been removed successfully.',
    failedToDeleteIbanCert: 'Failed to Delete IBAN Certificate',
    ibanCertPreviewFailed: 'Could not preview the IBAN certificate.',
    ibanCertDownloadFailed: 'Could not download the IBAN certificate.',
    previewIbanCert: 'Preview IBAN Certificate',
    downloadIbanCert: 'Download IBAN Certificate',
    uploadIbanCert: 'Upload Certificate',
    confirmDeleteIbanCert: 'Delete IBAN Certificate',
    confirmDeleteIbanCertDesc: 'Are you sure you want to delete this IBAN certificate?',
    ...
    procurementDescription: 'Manage inventory, maintenance, installations, and equipment procurement',
    ...
    priority: 'Priority',
    high: 'High',
    linkToExistingInventory: 'Link to Existing Inventory (Optional)',
    ...
    deleteProcurementConfirm: 'Are you sure you want to delete this procurement request?',
    noProcurementFound: 'No procurement requests found',
    failedToCreateProcurement: 'Failed to create procurement request',
    failedToUpdateProcurement: 'Failed to update procurement request',
    failedToDeleteProcurement: 'Failed to delete procurement request',
    failedToReorderProcurement: 'Failed to create reorder request',
    failedToSyncInventory: 'Failed to sync inventory',
    failedToSyncShopBills: 'Failed to sync shop bills',
    shopBillsSynced: 'Shop bills synced',
    inventorySynced: 'Synced inventory items to procurement',
    dragDropOrClickToUpload: 'Drag & drop or click to upload invoice',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (max 10MB)',
    automaticallyCalculated: 'Automatically calculated: Total Price ÷ Quantity',
    totalPriceForEntireStock: 'Total price for the entire stock quantity',
    ...
    projectCreatedDesc: 'Project has been created successfully',
    projectUpdated: 'Project Updated',
    projectUpdatedDesc: 'Project has been updated successfully',
    projectDeleted: 'Project Deleted',
    projectDeletedDesc: 'Project has been deleted successfully',
    ...
    noProjectsYet: 'No projects yet. Add your first project to get started.',
    ...
    noQuotationsFound: 'No quotations found matching your search',
    noQuotationsYet: 'No quotations yet. Add your first quotation to get started.',
    addFirstQuotation: 'Add your first quotation to get started',
    sent: 'Sent',
    declined: 'Declined',
    vatRate: 'VAT Rate (%)',
    totalAmount: 'Total Amount (SAR)',
    updateQuotationInfo: 'Update quotation information',
    addNewQuotation: 'Add a new quotation',
    deleteQuotationConfirm: 'Are you sure you want to delete this quotation? This action cannot be undone.',
    serviceCatalogPage: 'Service Catalog',
    serviceCatalogDescription: 'Manage your service offerings and pricing',
    addService: 'Add Service',
    editService: 'Edit Service',
    deleteService: 'Delete Service',
    serviceCreated: 'Service Created',
    serviceCreatedDesc: 'Service has been created successfully',
    serviceUpdated: 'Service Updated',
    serviceUpdatedDesc: 'Service has been updated successfully',
    serviceDeleted: 'Service Deleted',
    serviceDeletedDesc: 'Service has been deleted successfully',
    ...
    perPiece: 'Per Piece',
    perLength: 'Per Length (meter)',
    perArea: 'Per Area (sqm)',
    perHour: 'Per Hour',
    lumpSum: 'Lump Sum',
    ...
    contractorsDescription: 'Manage your contractors and service providers',
    ...
    contractorCreatedDesc: 'Contractor has been added successfully',
    contractorUpdated: 'Contractor Updated',
    contractorUpdatedDesc: 'Contractor has been updated successfully',
    contractorDeleted: 'Contractor Deleted',
    contractorDeletedDesc: 'Contractor has been deleted successfully',
    failedToCreateContractor: 'Failed to Add Contractor',
    failedToUpdateContractor: 'Failed to Update Contractor',
    failedToDeleteContractor: 'Failed to Delete Contractor',
    ...
    noContractorsFound: 'No contractors found matching your search',
    noContractorsYet: 'No contractors yet. Add your first contractor to get started.',
    addFirstContractor: 'Add your first contractor',
    updateContractorInfo: 'Update contractor information',
    addNewContractor: 'Add a new contractor',
    deleteContractorConfirm: 'Are you sure you want to delete this contractor? This action cannot be undone.',
  },
  ...
  Arabic: {
    ...
    inventoryForecastDesc: 'المتطلبات المتوقعة للمخزون بناءً على توقعات المبيعات',
    noInventoryData: 'لا تتوفر بيانات مخزون',
    linkRecipesToMenuItems: 'اربط الوصفات بعناصر القائمة لعرض توقعات المخزون',
    criticalStock: 'مخزون حرج',
    needsImmediateReorder: 'يحتاج إلى إعادة طلب فوري',
    reorderSoon: 'يُنصح بإعادة الطلب قريبًا',
    sufficientStock: 'مخزون كافٍ',
    stockLevelOk: 'مستويات المخزون مناسبة',
    ...
    low: 'منخفض',
    sufficient: 'كافٍ',
    showingTopInventory: 'عرض أعلى {count} عنصر مخزون حسب العجز',
    ...
    weeklyScheduleDesc: 'تكوين ساعات العمل لكل يوم من أيام الأسبوع',
    ...
    doYouHaveVatRegistration: 'هل لديك تسجيل ضريبة القيمة المضافة؟',
    selectVatRegistrationStatus: 'الرجاء اختيار ما إذا كان لديك تسجيل ضريبة القيمة المضافة',
    taxNumberRequired: 'رقم الضريبة مطلوب عند وجود تسجيل ضريبة القيمة المضافة',
    vatCertificateRequired: 'شهادة ضريبة القيمة المضافة مطلوبة عند وجود تسجيل ضريبة القيمة المضافة',
    uploadBusinessDocumentsDesc: 'ارفع مستندات عملك (اختياري، PDF فقط)',
    crCertificateRequired: 'شهادة السجل التجاري مطلوبة',
    ibanCertificateRequired: 'شهادة الآيبان مطلوبة',
    nationalAddressRequired: 'شهادة العنوان الوطني مطلوبة',
    uploadBusinessDocumentsRequiredDesc: 'ارفع مستندات عملك (PDF فقط، بحد أقصى 10 ميجابايت لكل ملف)',
    ...
    accountCreatedWithUsername: 'تم إنشاء حسابك "{username}". يرجى تسجيل الدخول.',
    anErrorOccurredDuringSignup: 'حدث خطأ أثناء التسجيل.',
    paymentNotCompleted: 'لم يتم إكمال الدفع. يرجى المحاولة مرة أخرى.',
    paymentStillPending: 'الدفع لا يزال قيد الانتظار. يرجى المحاولة مرة أخرى.',
    signupSessionExpired: 'انتهت جلسة التسجيل. يرجى المحاولة مرة أخرى.',
    accountCouldNotBeCreated: 'تعذر إنشاء الحساب. يرجى الاتصال بالدعم.',
    paymentProcessingError: 'خطأ في معالجة الدفع. يرجى المحاولة مرة أخرى.',
    paymentVerificationFailed: 'فشل التحقق من الدفع. يرجى الاتصال بالدعم إذا تم خصم الدفع.',
    redirectingToPayment: 'إعادة التوجيه إلى الدفع',
    pleaseCompleteSubscriptionPayment: 'يرجى إكمال دفع الاشتراك {amount} ريال سعودي',
    itAccountCreated: 'تم إنشاء حساب تكنولوجيا المعلومات',
    itAccountCreatedDesc: 'تم إنشاء حساب تكنولوجيا المعلومات بنجاح. يرجى تسجيل الدخول باستخدام بيانات الاعتماد الخاصة بك.',
    failedToCreateItAccount: 'فشل في إنشاء حساب تكنولوجيا المعلومات',
    pleaseIncludeSecretKey: 'يرجى ملء جميع الحقول بما فيها المفتاح السري',
    ...
    investorNationalId: 'الهوية (وطنية/إقامة)',
    enterNationalId: 'أدخل رقم الهوية',
    investorContactNumber: 'رقم التواصل',
    ...
    previewStatement: 'معاينة كشف الحساب',
    statementPreviewFailed: 'فشل المعاينة',
    previewStatementDesc: 'معاينة كشف حساب المستثمر أدناه',
    ...
    ibanAccount: 'رقم الآيبان',
    ibanHelp: 'صيغة الآيبان السعودي: SA متبوعة بـ 22 رقم',
    ibanCertificate: 'شهادة الآيبان',
    ibanCertUploaded: 'تم تحميل شهادة الآيبان',
    ibanCertUploadedDesc: 'تم تحميل شهادة الآيبان بنجاح.',
    failedToUploadIbanCert: 'فشل تحميل شهادة الآيبان',
    ibanCertDeleted: 'تم حذف شهادة الآيبان',
    ibanCertDeletedDesc: 'تم حذف شهادة الآيبان بنجاح.',
    failedToDeleteIbanCert: 'فشل حذف شهادة الآيبان',
    ibanCertPreviewFailed: 'فشل معاينة شهادة الآيبان.',
    ibanCertDownloadFailed: 'فشل تحميل شهادة الآيبان.',
    previewIbanCert: 'معاينة شهادة الآيبان',
    downloadIbanCert: 'تحميل شهادة الآيبان',
    uploadIbanCert: 'تحميل الشهادة',
    confirmDeleteIbanCert: 'حذف شهادة الآيبان',
    confirmDeleteIbanCertDesc: 'هل أنت متأكد من رغبتك في حذف شهادة الآيبان هذه؟',
    addSalary: 'إضافة راتب',
    ...
    procurementDescription: 'إدارة المخزون والصيانة والتركيبات وشراء المعدات',
    editProcurement: 'تعديل المشتريات',
    newProcurementRequest: 'طلب مشتريات جديد',
    newRequest: 'طلب جديد',
    installation: 'تركيب',
    priority: 'الأولوية',
    high: 'عالي',
    linkToExistingInventory: 'ربط بمخزون موجود (اختياري)',
    createNewInventoryItem: 'إنشاء صنف مخزون جديد',
    title: 'العنوان',
    ...
    update: 'تحديث',
    create: 'إنشاء',
    syncShopBills: 'مزامنة فواتير المتجر',
    ...
    approve: 'موافقة',
    markAsOrdered: 'وضع علامة تم الطلب',
    markAsReceived: 'وضع علامة مستلم',
    markAsCompleted: 'وضع علامة مكتمل',
    deleteProcurementConfirm: 'هل أنت متأكد من حذف طلب المشتريات هذا؟',
    noProcurementFound: 'لم يتم العثور على طلبات مشتريات',
    failedToCreateProcurement: 'فشل إنشاء طلب المشتريات',
    failedToUpdateProcurement: 'فشل تحديث طلب المشتريات',
    failedToDeleteProcurement: 'فشل حذف طلب المشتريات',
    failedToReorderProcurement: 'فشل إنشاء طلب إعادة الطلب',
    failedToSyncInventory: 'فشل مزامنة المخزون',
    failedToSyncShopBills: 'فشل مزامنة فواتير المتجر',
    shopBillsSynced: 'تمت مزامنة فواتير المتجر',
    inventorySynced: 'تمت مزامنة أصناف المخزون إلى المشتريات',
    dragDropOrClickToUpload: 'اسحب وأفلت أو انقر لتحميل الفاتورة',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (الحد الأقصى 10 ميجابايت)',
    automaticallyCalculated: 'محسوب تلقائياً: السعر الإجمالي ÷ الكمية',
    totalPriceForEntireStock: 'السعر الإجمالي لكامل كمية المخزون',
    expectedDelivery: 'متوقع',
    reorderCreated: 'تم إنشاء طلب إعادة الطلب بنجاح',
    ...
    projectCreatedDesc: 'تم إنشاء المشروع بنجاح',
    projectUpdated: 'تم تحديث المشروع',
    projectUpdatedDesc: 'تم تحديث المشروع بنجاح',
    projectDeleted: 'تم حذف المشروع',
    projectDeletedDesc: 'تم حذف المشروع بنجاح',
    ...
    startDate: 'تاريخ البدء',
    endDate: 'تاريخ الانتهاء',
    estimatedBudget: 'الميزانية التقديرية (ريال)',
    ...
    noProjectsYet: 'لا توجد مشاريع بعد. أضف أول مشروع للبدء.',
    addFirstProject: 'أضف أول مشروع للبدء',
    ...
    addNewProject: 'إضافة مشروع خدمة جديد',
    deleteProjectConfirm: 'هل أنت متأكد من حذف هذا المشروع؟ لا يمكن التراجع عن هذا الإجراء.',
    quotationsPage: 'عروض الأسعار',
    quotationsDescription: 'إدارة عروض الأسعار والمقترحات',
    addQuotation: 'إضافة عرض سعر',
    editQuotation: 'تعديل عرض السعر',
    deleteQuotation: 'حذف عرض السعر',
    quotationCreated: 'تم إنشاء عرض السعر',
    quotationCreatedDesc: 'تم إنشاء عرض السعر بنجاح',
    quotationUpdated: 'تم تحديث عرض السعر',
    quotationUpdatedDesc: 'تم تحديث عرض السعر بنجاح',
    quotationDeleted: 'تم حذف عرض السعر',
    quotationDeletedDesc: 'تم حذف عرض السعر بنجاح',
    ...
    approvedQuotations: 'معتمدة',
    approvedAmount: 'المبلغ المعتمد',
    noQuotationsFound: 'لا توجد عروض أسعار مطابقة للبحث',
    noQuotationsYet: 'لا توجد عروض أسعار بعد. أضف أول عرض سعر للبدء.',
    addFirstQuotation: 'أضف أول عرض سعر للبدء',
    sent: 'مرسل',
    declined: 'مرفوض',
    vatRate: 'نسبة ضريبة القيمة المضافة (%)',
    totalAmount: 'المبلغ الإجمالي (ريال)',
    updateQuotationInfo: 'تحديث معلومات عرض السعر',
    addNewQuotation: 'إضافة عرض سعر جديد',
    deleteQuotationConfirm: 'هل أنت متأكد من حذف عرض السعر هذا؟ لا يمكن التراجع عن هذا الإجراء.',
    serviceCatalogPage: 'كتالوج الخدمات',
    serviceCatalogDescription: 'إدارة خدماتك وأسعارك',
    addService: 'إضافة خدمة',
    editService: 'تعديل الخدمة',
    deleteService: 'حذف الخدمة',
    serviceCreated: 'تم إنشاء الخدمة',
    serviceCreatedDesc: 'تم إنشاء الخدمة بنجاح',
    serviceUpdated: 'تم تحديث الخدمة',
    serviceUpdatedDesc: 'تم تحديث الخدمة بنجاح',
    serviceDeleted: 'تم حذف الخدمة',
    serviceDeletedDesc: 'تم حذف الخدمة بنجاح',
    ...
    noServicesFound: 'لا توجد خدمات مطابقة للبحث',
    noServicesYet: 'لا توجد خدمات بعد. أضف أول خدمة للبدء.',
    addFirstService: 'أضف أول خدمة للبدء',
    perPiece: 'لكل قطعة',
    perLength: 'لكل متر',
    perArea: 'لكل متر مربع',
    perHour: 'لكل ساعة',
    lumpSum: 'مبلغ مقطوع',
    serviceDescription: 'وصف الخدمة...',
    updateServiceInfo: 'تحديث معلومات الخدمة',
    addNewService: 'إضافة خدمة جديدة',
    deleteServiceConfirm: 'هل أنت متأكد من حذف هذه الخدمة؟ لا يمكن التراجع عن هذا الإجراء.',
    contractorsPage: 'المقاولون',
    contractorsDescription: 'إدارة المقاولين ومقدمي الخدمات',
    addContractor: 'إضافة مقاول',
    editContractor: 'تعديل المقاول',
    deleteContractor: 'حذف المقاول',
    contractorCreated: 'تم إضافة المقاول',
    contractorCreatedDesc: 'تم إضافة المقاول بنجاح',
    contractorUpdated: 'تم تحديث المقاول',
    contractorUpdatedDesc: 'تم تحديث المقاول بنجاح',
    contractorDeleted: 'تم حذف المقاول',
    contractorDeletedDesc: 'تم حذف المقاول بنجاح',
    failedToCreateContractor: 'فشل في إضافة المقاول',
    failedToUpdateContractor: 'فشل في تحديث المقاول',
    failedToDeleteContractor: 'فشل في حذف المقاول',
    contractorName: 'اسم المقاول',
    specialization: 'التخصص',
    rating: 'التقييم',
    totalContractors: 'إجمالي المقاولين',
    activeContractors: 'نشط',
    avgRating: 'متوسط التقييم',
    specializations: 'التخصصات',
    noContractorsFound: 'لا يوجد مقاولون مطابقون للبحث',
    noContractorsYet: 'لا يوجد مقاولون بعد. أضف أول مقاول للبدء.',
    addFirstContractor: 'أضف أول مقاول',
    updateContractorInfo: 'تحديث معلومات المقاول',
    addNewContractor: 'إضافة مقاول جديد',
    deleteContractorConfirm: 'هل أنت متأكد من حذف هذا المقاول؟ لا يمكن التراجع عن هذا الإجراء.',
  },
  German: {
    // Navigation
    dashboard: 'Dashboard',
    ...
    inventoryForecastDesc: 'Prognostizierter Lagerbedarf basierend auf Verkaufsprognose',
    noInventoryData: 'Keine Bestandsdaten verfügbar',
    linkRecipesToMenuItems: 'Rezepte mit Menüpunkten verknüpfen, um Bestandsprognosen zu sehen',
    criticalStock: 'Kritischer Bestand',
    needsImmediateReorder: 'Sofortige Nachbestellung erforderlich',
    reorderSoon: 'Baldige Nachbestellung empfohlen',
    sufficientStock: 'Ausreichender Bestand',
    stockLevelOk: 'Bestandsniveau ist angemessen',
    inventoryItem: 'Lagerartikel',
    currentStock: 'Aktueller Bestand',
    requiredQuantity: 'Benötigte Menge',
    shortfall: 'Fehlmenge',
    critical: 'Kritisch',
    low: 'Niedrig',
    sufficient: 'Ausreichend',
    showingTopInventory: 'Zeige Top {count} Lagerartikel nach Fehlmenge',
    ...
    weeklyScheduleDesc: 'Betriebszeiten für jeden Wochentag konfigurieren',
    ...
    enterInvestorName: 'Enter investor name',
    investorNationalId: 'ID (National/Iqama)',
    enterNationalId: 'ID-Nummer eingeben',
    investorContactNumber: 'Kontaktnummer',
    ...
    ibanHelp: 'Saudi IBAN Format: SA gefolgt von 22 Ziffern',
    ibanCertificate: 'IBAN-Zertifikat',
    ibanCertUploaded: 'IBAN-Zertifikat hochgeladen',
    ibanCertUploadedDesc: 'IBAN-Zertifikat wurde erfolgreich hochgeladen.',
    failedToUploadIbanCert: 'Fehler beim Hochladen des IBAN-Zertifikats',
    ibanCertDeleted: 'IBAN-Zertifikat gelöscht',
    ibanCertDeletedDesc: 'IBAN-Zertifikat wurde erfolgreich entfernt.',
    failedToDeleteIbanCert: 'Fehler beim Löschen des IBAN-Zertifikats',
    ibanCertPreviewFailed: 'Vorschau des IBAN-Zertifikats konnte nicht angezeigt werden.',
    ibanCertDownloadFailed: 'Download des IBAN-Zertifikats ist fehlgeschlagen.',
    previewIbanCert: 'IBAN-Zertifikat anzeigen',
    downloadIbanCert: 'IBAN-Zertifikat herunterladen',
    uploadIbanCert: 'Zertifikat hochladen',
    confirmDeleteIbanCert: 'IBAN-Zertifikat löschen',
    confirmDeleteIbanCertDesc: 'Sind Sie sicher, dass Sie dieses IBAN-Zertifikat löschen möchten?',
    addSalary: 'Add Salary',
    editSalary: 'Edit Salary',
    salaryFormDescription: 'Enter employee salary information',
    totalSalaries: 'Total Salaries',
    ...
    procurementDescription: 'Inventar, Wartung, Installationen und Gerätebeschaffung verwalten',
    editProcurement: 'Beschaffung bearbeiten',
    newProcurementRequest: 'Neue Beschaffungsanfrage',
    newRequest: 'Neue Anfrage',
    installation: 'Installation',
    priority: 'Priorität',
    high: 'Hoch',
    linkToExistingInventory: 'Mit vorhandenem Inventar verknüpfen (Optional)',
    createNewInventoryItem: 'Neuen Inventarartikel erstellen',
    title: 'Titel',
    ...
    create: 'Erstellen',
    syncShopBills: 'Shop-Rechnungen synchronisieren',
    syncInventory: 'Inventar synchronisieren',
    syncing: 'Synchronisieren...',
    totalRequests: 'Anfragen gesamt',
    inProgress: 'In Bearbeitung',
    procurementRequests: 'Beschaffungsanfragen',
    ...
    deleteProcurementConfirm: 'Sind Sie sicher, dass Sie diese Beschaffungsanfrage löschen möchten?',
    noProcurementFound: 'Keine Beschaffungsanfragen gefunden',
    failedToCreateProcurement: 'Beschaffungsanfrage konnte nicht erstellt werden',
    failedToUpdateProcurement: 'Beschaffungsanfrage konnte nicht aktualisiert werden',
    failedToDeleteProcurement: 'Beschaffungsanfrage konnte nicht gelöscht werden',
    failedToReorderProcurement: 'Nachbestellung konnte nicht erstellt werden',
    failedToSyncInventory: 'Inventar konnte nicht synchronisiert werden',
    failedToSyncShopBills: 'Shop-Rechnungen konnten nicht synchronisiert werden',
    shopBillsSynced: 'Shop-Rechnungen synchronisiert',
    inventorySynced: 'Inventarartikel zur Beschaffung synchronisiert',
    dragDropOrClickToUpload: 'Ziehen und ablegen oder klicken zum Hochladen',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (max 10MB)',
    automaticallyCalculated: 'Automatisch berechnet: Gesamtpreis ÷ Menge',
    totalPriceForEntireStock: 'Gesamtpreis für die gesamte Lagermenge',
    expectedDelivery: 'Erwartet',
    reorderCreated: 'Nachbestellung erfolgreich erstellt',
    ...
    projectCreatedDesc: 'Projekt wurde erfolgreich erstellt',
    projectUpdated: 'Projekt aktualisiert',
    projectUpdatedDesc: 'Projekt wurde erfolgreich aktualisiert',
    projectDeleted: 'Projekt gelöscht',
    projectDeletedDesc: 'Projekt wurde erfolgreich gelöscht',
    failedToCreateProject: 'Projekt konnte nicht erstellt werden',
    ...
    endDate: 'Enddatum',
    estimatedBudget: 'Geschätztes Budget (SAR)',
    ...
    noProjectsYet: 'Noch keine Projekte. Fügen Sie Ihr erstes Projekt hinzu.',
    ...
    medium: 'Mittel',
    high: 'Hoch',
    updateProjectInfo: 'Projektinformationen aktualisieren',
    addNewProject: 'Neues Serviceprojekt hinzufügen',
    deleteProjectConfirm: 'Sind Sie sicher, dass Sie dieses Projekt löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.',
    quotationsPage: 'Angebote',
    quotationsDescription: 'Verwalten Sie Ihre Angebote und Vorschläge',
    addQuotation: 'Angebot hinzufügen',
    editQuotation: 'Angebot bearbeiten',
    deleteQuotation: 'Angebot löschen',
    quotationCreated: 'Angebot erstellt',
    quotationCreatedDesc: 'Angebot wurde erfolgreich erstellt',
    quotationUpdated: 'Angebot aktualisiert',
    quotationUpdatedDesc: 'Angebot wurde erfolgreich aktualisiert',
    quotationDeleted: 'Angebot gelöscht',
    quotationDeletedDesc: 'Angebot wurde erfolgreich gelöscht',
    failedToCreateQuotation: 'Angebot konnte nicht erstellt werden',
    failedToUpdateQuotation: 'Angebot konnte nicht aktualisiert werden',
    failedToDeleteQuotation: 'Angebot konnte nicht gelöscht werden',
    quotationNumber: 'Angebotsnummer',
    validUntil: 'Gültig bis',
    totalQuotations: 'Gesamtangebote',
    pendingQuotations: 'Ausstehend',
    approvedQuotations: 'Genehmigt',
    approvedAmount: 'Genehmigter Betrag',
    noQuotationsFound: 'Keine Angebote gefunden',
    noQuotationsYet: 'Noch keine Angebote. Fügen Sie Ihr erstes Angebot hinzu.',
    addFirstQuotation: 'Fügen Sie Ihr erstes Angebot hinzu',
    sent: 'Gesendet',
    declined: 'Abgelehnt',
    vatRate: 'MwSt.-Satz (%)',
    totalAmount: 'Gesamtbetrag (SAR)',
    updateQuotationInfo: 'Angebotsinformationen aktualisieren',
    addNewQuotation: 'Neues Angebot hinzufügen',
    deleteQuotationConfirm: 'Sind Sie sicher, dass Sie dieses Angebot löschen möchten?',
    serviceCatalogPage: 'Dienstleistungskatalog',
    serviceCatalogDescription: 'Verwalten Sie Ihre Dienstleistungen und Preise',
    addService: 'Dienst hinzufügen',
    editService: 'Dienst bearbeiten',
    deleteService: 'Dienst löschen',
    serviceCreated: 'Dienst erstellt',
    serviceCreatedDesc: 'Dienst wurde erfolgreich erstellt',
    serviceUpdated: 'Dienst aktualisiert',
    serviceUpdatedDesc: 'Dienst wurde erfolgreich aktualisiert',
    serviceDeleted: 'Dienst gelöscht',
    serviceDeletedDesc: 'Dienst wurde erfolgreich gelöscht',
    failedToCreateService: 'Dienst konnte nicht erstellt werden',
    failedToUpdateService: 'Dienst konnte nicht aktualisiert werden',
    failedToDeleteService: 'Dienst konnte nicht gelöscht werden',
    serviceName: 'Dienstleistungsname',
    pricingMethod: 'Preismethode',
    ...
    noServicesYet: 'Noch keine Dienste. Fügen Sie Ihren ersten Dienst hinzu.',
    addFirstService: 'Fügen Sie Ihren ersten Dienst hinzu',
    perPiece: 'Pro Stück',
    perLength: 'Pro Meter',
    perArea: 'Pro Quadratmeter',
    perHour: 'Pro Stunde',
    lumpSum: 'Pauschale',
    serviceDescription: 'Dienstleistungsbeschreibung...',
    updateServiceInfo: 'Dienstleistungsinformationen aktualisieren',
    addNewService: 'Neuen Dienst hinzufügen',
    deleteServiceConfirm: 'Sind Sie sicher, dass Sie diesen Dienst löschen möchten?',
    contractorsPage: 'Auftragnehmer',
    contractorsDescription: 'Verwalten Sie Ihre Auftragnehmer und Dienstleister',
    addContractor: 'Auftragnehmer hinzufügen',
    editContractor: 'Auftragnehmer bearbeiten',
    deleteContractor: 'Auftragnehmer löschen',
    contractorCreated: 'Auftragnehmer hinzugefügt',
    contractorCreatedDesc: 'Auftragnehmer wurde erfolgreich hinzugefügt',
    contractorUpdated: 'Auftragnehmer aktualisiert',
    contractorUpdatedDesc: 'Auftragnehmer wurde erfolgreich aktualisiert',
    contractorDeleted: 'Auftragnehmer gelöscht',
    contractorDeletedDesc: 'Auftragnehmer wurde erfolgreich gelöscht',
    failedToCreateContractor: 'Auftragnehmer konnte nicht hinzugefügt werden',
    failedToUpdateContractor: 'Auftragnehmer konnte nicht aktualisiert werden',
    failedToDeleteContractor: 'Auftragnehmer konnte nicht gelöscht werden',
    contractorName: 'Auftragnehmername',
    specialization: 'Spezialisierung',
    rating: 'Bewertung',
    totalContractors: 'Gesamtauftragnehmer',
    activeContractors: 'Aktiv',
    avgRating: 'Durchschnittsbewertung',
    specializations: 'Spezialisierungen',
    noContractorsFound: 'Keine Auftragnehmer gefunden',
    noContractorsYet: 'Noch keine Auftragnehmer. Fügen Sie Ihren ersten Auftragnehmer hinzu.',
    addFirstContractor: 'Fügen Sie Ihren ersten Auftragnehmer hinzu',
    updateContractorInfo: 'Auftragnehmerinformationen aktualisieren',
    addNewContractor: 'Neuen Auftragnehmer hinzufügen',
    deleteContractorConfirm: 'Sind Sie sicher, dass Sie diesen Auftragnehmer löschen möchten?',
  },
  Chinese: {
    // Navigation
    dashboard: '仪表板',
    ...
    inventoryForecastDesc: '基于销售预测的预计库存需求',
    noInventoryData: '没有可用的库存数据',
    linkRecipesToMenuItems: '将配方与菜单项关联以查看库存预测',
    criticalStock: '库存紧急',
    needsImmediateReorder: '需要立即补货',
    reorderSoon: '建议尽快补货',
    ...
    low: '低',
    sufficient: '充足',
    showingTopInventory: '按短缺量显示前 {count} 个库存项目',
    ...
    schedule: '日程',
    weeklySchedule: '周计划',
    weeklyScheduleDesc: '配置每周每天的营业时间',
    ...
    investorName: 'Investor Name',
    enterInvestorName: 'Enter investor name',
    investorNationalId: '证件号码（身份证/居留证）',
    enterNationalId: '输入证件号码',
    investorContactNumber: '联系电话',
    ...
    selectBank: '选择银行',
    ibanAccount: 'IBAN账号',
    ibanHelp: '沙特IBAN格式：SA后跟22位数字',
    ibanCertificate: '伊班证书',
    ibanCertUploaded: '已上传伊班证书',
    ibanCertUploadedDesc: '伊班证书已成功上传。',
    failedToUploadIbanCert: '上传伊班证书失败',
    ibanCertDeleted: '伊班证书已删除',
    ibanCertDeletedDesc: '伊班证书已成功删除。',
    failedToDeleteIbanCert: '删除伊班证书失败',
    ibanCertPreviewFailed: '无法预览伊班证书。',
    ibanCertDownloadFailed: '无法下载伊班证书。',
    previewIbanCert: '预览伊班证书',
    downloadIbanCert: '下载伊班证书',
    uploadIbanCert: '上传证书',
    confirmDeleteIbanCert: '删除伊班证书',
    confirmDeleteIbanCertDesc: '您确定要删除此伊班证书吗？',
    addSalary: 'Add Salary',
    editSalary: 'Edit Salary',
    salaryFormDescription: 'Enter employee salary information',
    totalSalaries: 'Total Salaries',
    ...
    procurementDescription: '管理库存、维护、安装和设备采购',
    editProcurement: '编辑采购',
    newProcurementRequest: '新采购申请',
    newRequest: '新申请',
    installation: '安装',
    priority: '优先级',
    high: '高',
    linkToExistingInventory: '链接到现有库存（可选）',
    createNewInventoryItem: '创建新库存项目',
    title: '标题',
    enterTitle: '输入标题',
    totalCost: '总成本',
    requestedBy: '申请人',
    ...
    allStatuses: '所有状态',
    approve: '批准',
    markAsOrdered: '标记为已订购',
    markAsReceived: '标记为已收货',
    markAsCompleted: '标记为已完成',
    deleteProcurementConfirm: '您确定要删除此采购申请吗？',
    noProcurementFound: '未找到采购申请',
    failedToCreateProcurement: '创建采购申请失败',
    failedToUpdateProcurement: '更新采购申请失败',
    failedToDeleteProcurement: '删除采购申请失败',
    failedToReorderProcurement: '创建补货申请失败',
    failedToSyncInventory: '同步库存失败',
    failedToSyncShopBills: '同步商店账单失败',
    shopBillsSynced: '商店账单已同步',
    inventorySynced: '库存项目已同步到采购',
    dragDropOrClickToUpload: '拖放或点击上传发票',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF（最大10MB）',
    automaticallyCalculated: '自动计算：总价 ÷ 数量',
    totalPriceForEntireStock: '整个库存数量的总价',
    expectedDelivery: '预计',
    reorderCreated: '补货申请创建成功',
    selectCategory: '选择类别',
    supplierName: '供应商名称',
  ...
  Bengali: {
    ...
    inventoryForecast: 'ইনভেন্টরি পূর্বাভাস',
    inventoryForecastDesc: 'বিক্রয় পূর্বাভাসের উপর ভিত্তি করে প্রত্যাশিত ইনভেন্টরি প্রয়োজনীয়তা',
    noInventoryData: 'কোনো ইনভেন্টরি ডেটা উপলব্ধ নেই',
    linkRecipesToMenuItems: 'ইনভেন্টরি পূর্বাভাস দেখতে রেসিপি মেনু আইটেমের সাথে লিঙ্ক করুন',
    criticalStock: 'জরুরি স্টক',
    needsImmediateReorder: 'তাৎক্ষণিক পুনরায় অর্ডার প্রয়োজন',
    reorderSoon: 'শীঘ্রই পুনরায় অর্ডার করার পরামর্শ দেওয়া হচ্ছে',
    sufficientStock: 'পর্যাপ্ত স্টক',
    stockLevelOk: 'স্টকের মাত্রা যথেষ্ট',
    inventoryItem: 'ইনভেন্টরি আইটেম',
    ...
    low: 'কম',
    sufficient: 'পর্যাপ্ত',
    showingTopInventory: 'ঘাটতি অনুসারে শীর্ষ {count} ইনভেন্টরি আইটেম দেখানো হচ্ছে',
    ...
    weeklyScheduleDesc: 'সপ্তাহের প্রতিটি দিনের জন্য কাজের সময় কনফিগার করুন',
    ...
    paid: 'Paid',
    notes: 'Notes',
    selectBank: 'একটি ব্যাংক নির্বাচন করুন',
    ibanAccount: 'IBAN অ্যাকাউন্ট',
    ibanHelp: 'সৌদি IBAN ফর্ম্যাট: SA এর পরে ২২ সংখ্যা',
    ibanCertificate: 'IBAN সার্টিফিকেট',
    ibanCertUploaded: 'IBAN সার্টিফিকেট আপলোড হয়েছে',
    ibanCertUploadedDesc: 'IBAN সার্টিফিকেট সফলভাবে আপলোড হয়েছে।',
    failedToUploadIbanCert: 'IBAN সার্টিফিকেট আপলোড করতে ব্যর্থ হয়েছে',
    ibanCertDeleted: 'IBAN সার্টিফিকেট মুছে ফেলা হয়েছে',
    ibanCertDeletedDesc: 'IBAN সার্টিফিকেট সফলভাবে অপসারণ করা হয়েছে।',
    failedToDeleteIbanCert: 'IBAN সার্টিফিকেট মুছতে ব্যর্থ হয়েছে',
    ibanCertPreviewFailed: 'IBAN সার্টিফিকেট প্রিভিউ করতে পারা যায়নি।',
    ibanCertDownloadFailed: 'IBAN সার্টিফিকেট ডাউনলোড করতে পারা যায়নি।',
    previewIbanCert: 'IBAN সার্টিফিকেট প্রিভিউ করুন',
    downloadIbanCert: 'IBAN সার্টিফিকেট ডাউনলোড করুন',
    uploadIbanCert: 'সার্টিফিকেট আপলোড করুন',
    confirmDeleteIbanCert: 'IBAN সার্টিফিকেট মুছুন',
    confirmDeleteIbanCertDesc: 'আপনি কি এই IBAN সার্টিফিকেটটি মুছতে চান?',
    addSalary: 'Add Salary',
    editSalary: 'Edit Salary',
    salaryFormDescription: 'Enter employee salary information',
    totalSalaries: 'Total Salaries',
    ...
    // Procurement Page Keys
    procurementManagement: 'সংগ্রহ ব্যবস্থাপনা',
    procurementDescription: 'ইনভেন্টরি, রক্ষণাবেক্ষণ, ইনস্টলেশন এবং সরঞ্জাম সংগ্রহ পরিচালনা করুন',
    editProcurement: 'সংগ্রহ সম্পাদনা করুন',
    newProcurementRequest: 'নতুন সংগ্রহ অনুরোধ',
    newRequest: 'নতুন অনুরোধ',
    installation: 'ইনস্টলেশন',
    priority: 'অগ্রাধিকার',
    high: 'উচ্চ',
    linkToExistingInventory: 'বিদ্যমান ইনভেন্টরিতে লিঙ্ক করুন (ঐচ্ছিক)',
    createNewInventoryItem: 'নতুন ইনভেন্টরি আইটেম তৈরি করুন',
    title: 'শিরোনাম',
    ...
    update: 'আপডেট',
    create: 'তৈরি করুন',
    syncShopBills: 'দোকানের বিল সিঙ্ক করুন',
    syncInventory: 'ইনভেন্টরি সিঙ্ক করুন',
    syncing: 'সিঙ্ক হচ্ছে...',
    totalRequests: 'মোট অনুরোধ',
    inProgress: 'চলমান',
    procurementRequests: 'সংগ্রহ অনুরোধ',
    filterByStatus: 'স্ট্যাটাস দ্বারা ফিল্টার করুন',
    allStatuses: 'সব স্ট্যাটাস',
    approve: 'অনুমোদন',
    markAsOrdered: 'অর্ডার করা হিসাবে চিহ্নিত করুন',
    markAsReceived: 'প্রাপ্ত হিসাবে চিহ্নিত করুন',
    markAsCompleted: 'সম্পন্ন হিসাবে চিহ্নিত করুন',
    deleteProcurementConfirm: 'আপনি কি এই সংগ্রহ অনুরোধটি মুছে ফেলতে চান?',
    noProcurementFound: 'কোনো সংগ্রহ অনুরোধ পাওয়া যায়নি',
    failedToCreateProcurement: 'সংগ্রহ অনুরোধ তৈরি করতে ব্যর্থ',
    failedToUpdateProcurement: 'সংগ্রহ অনুরোধ আপডেট করতে ব্যর্থ',
    failedToDeleteProcurement: 'সংগ্রহ অনুরোধ মুছতে ব্যর্থ',
    failedToReorderProcurement: 'পুনর্বিন্যাস অনুরোধ তৈরি করতে ব্যর্থ',
    failedToSyncInventory: 'ইনভেন্টরি সিঙ্ক করতে ব্যর্থ',
    failedToSyncShopBills: 'দোকানের বিল সিঙ্ক করতে ব্যর্থ',
    shopBillsSynced: 'দোকানের বিল সিঙ্ক হয়েছে',
    inventorySynced: 'ইনভেন্টরি আইটেম সংগ্রহে সিঙ্ক হয়েছে',
    dragDropOrClickToUpload: 'ইনভয়েস আপলোড করতে ড্র্যাগ এবং ড্রপ করুন বা ক্লিক করুন',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (সর্বোচ্চ 10MB)',
    automaticallyCalculated: 'স্বয়ংক্রিয়ভাবে গণনা: মোট মূল্য ÷ পরিমাণ',
    totalPriceForEntireStock: 'সম্পূর্ণ স্টক পরিমাণের মোট মূল্য',
    expectedDelivery: 'প্রত্যাশিত',
    reorderCreated: 'পুনর্বিন্যাস অনুরোধ সফলভাবে তৈরি হয়েছে',
  ...
  Italian: {
    ...
    inventoryForecastDesc: 'Requisiti di inventario previsti basati sulla previsione delle vendite',
    noInventoryData: 'Nessun dato di inventario disponibile',
    linkRecipesToMenuItems: 'Collega le ricette agli articoli del menu per vedere le previsioni di inventario',
    criticalStock: 'Stock Critico',
    needsImmediateReorder: 'Riordino immediato necessario',
    reorderSoon: 'Si consiglia di riordinare presto',
    sufficientStock: 'Stock Sufficiente',
    stockLevelOk: 'Livelli di stock adeguati',
    inventoryItem: 'Articolo Inventario',
    currentStock: 'Stock Attuale',
    requiredQuantity: 'Quantità Richiesta',
    shortfall: 'Carenza',
    critical: 'Critico',
    low: 'Basso',
    sufficient: 'Sufficiente',
    showingTopInventory: 'Mostrando i primi {count} articoli per carenza',
    ...
    weeklyScheduleDesc: 'Configura gli orari di lavoro per ogni giorno della settimana',
    ...
    investorName: 'Investor Name',
    enterInvestorName: 'Enter investor name',
    investorNationalId: 'ID (Nazionale/Iqama)',
    enterNationalId: 'Inserisci numero ID',
    investorContactNumber: 'Numero di Contatto',
    ...
    ibanHelp: 'Formato IBAN saudita: SA seguito da 22 cifre',
    ibanCertificate: 'Certificato IBAN',
    ibanCertUploaded: 'Certificato IBAN caricato',
    ibanCertUploadedDesc: 'Il certificato IBAN è stato caricato con successo.',
    failedToUploadIbanCert: 'Impossibile caricare il certificato IBAN',
    ibanCertDeleted: 'Certificato IBAN eliminato',
    ibanCertDeletedDesc: 'Il certificato IBAN è stato rimosso con successo.',
    failedToDeleteIbanCert: 'Impossibile eliminare il certificato IBAN',
    ibanCertPreviewFailed: 'Impossibile visualizzare l\'anteprima del certificato IBAN.',
    ibanCertDownloadFailed: 'Impossibile scaricare il certificato IBAN.',
    previewIbanCert: 'Anteprima certificato IBAN',
    downloadIbanCert: 'Scarica certificato IBAN',
    uploadIbanCert: 'Carica certificato',
    confirmDeleteIbanCert: 'Elimina certificato IBAN',
    confirmDeleteIbanCertDesc: 'Sei sicuro di voler eliminare questo certificato IBAN?',
    addSalary: 'Add Salary',
    editSalary: 'Edit Salary',
    salaryFormDescription: 'Enter employee salary information',
    totalSalaries: 'Total Salaries',
    ...
    // Procurement Page Keys
    procurementManagement: 'Gestione Approvvigionamento',
    procurementDescription: 'Gestisci inventario, manutenzione, installazioni e approvvigionamento attrezzature',
    editProcurement: 'Modifica Approvvigionamento',
    newProcurementRequest: 'Nuova Richiesta di Approvvigionamento',
    newRequest: 'Nuova Richiesta',
    installation: 'Installazione',
    priority: 'Priorità',
    high: 'Alta',
    linkToExistingInventory: 'Collega a Inventario Esistente (Opzionale)',
    createNewInventoryItem: 'Crea Nuovo Articolo Inventario',
    title: 'Titolo',
    ...
    update: 'Aggiorna',
    create: 'Crea',
    syncShopBills: 'Sincronizza Fatture Negozio',
    syncInventory: 'Sincronizza Inventario',
    syncing: 'Sincronizzazione...',
    totalRequests: 'Richieste Totali',
    inProgress: 'In Corso',
    procurementRequests: 'Richieste di Approvvigionamento',
    filterByStatus: 'Filtra per stato',
    allStatuses: 'Tutti gli Stati',
    approve: 'Approva',
    markAsOrdered: 'Segna come Ordinato',
    markAsReceived: 'Segna come Ricevuto',
    markAsCompleted: 'Segna come Completato',
    deleteProcurementConfirm: 'Sei sicuro di voler eliminare questa richiesta di approvvigionamento?',
    noProcurementFound: 'Nessuna richiesta di approvvigionamento trovata',
    failedToCreateProcurement: 'Impossibile creare la richiesta di approvvigionamento',
    failedToUpdateProcurement: 'Impossibile aggiornare la richiesta di approvvigionamento',
    failedToDeleteProcurement: 'Impossibile eliminare la richiesta di approvvigionamento',
    failedToReorderProcurement: 'Impossibile creare la richiesta di riordino',
    failedToSyncInventory: 'Impossibile sincronizzare l\'inventario',
    failedToSyncShopBills: 'Impossibile sincronizzare le fatture del negozio',
    shopBillsSynced: 'Fatture negozio sincronizzate',
    inventorySynced: 'Articoli inventario sincronizzati con approvvigionamento',
    dragDropOrClickToUpload: 'Trascina e rilascia o clicca per caricare la fattura',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (max 10MB)',
    automaticallyCalculated: 'Calcolato automaticamente: Prezzo Totale ÷ Quantità',
    totalPriceForEntireStock: 'Prezzo totale per l\'intera quantità di stock',
    expectedDelivery: 'Previsto',
    reorderCreated: 'Richiesta di riordino creata con successo',
  ...
  Hindi: {
    ...
    inventoryForecast: 'इन्वेंटरी पूर्वानुमान',
    inventoryForecastDesc: 'बिक्री पूर्वानुमान के आधार पर अनुमानित इन्वेंटरी आवश्यकताएं',
    noInventoryData: 'कोई इन्वेंटरी डेटा उपलब्ध नहीं',
    linkRecipesToMenuItems: 'इन्वेंटरी पूर्वानुमान देखने के लिए रेसिपी को मेनू आइटम से लिंक करें',
    criticalStock: 'गंभीर स्टॉक',
    needsImmediateReorder: 'तुरंत पुनर्आदेश की आवश्यकता',
    reorderSoon: 'जल्द पुनर्आदेश की सलाह दी जाती है',
    sufficientStock: 'पर्याप्त स्टॉक',
    stockLevelOk: 'स्टॉक स्तर पर्याप्त है',
    inventoryItem: 'इन्वेंटरी आइटम',
    ...
    low: 'कम',
    sufficient: 'पर्याप्त',
    showingTopInventory: 'कमी के अनुसार शीर्ष {count} इन्वेंटरी आइटम दिखाए जा रहे हैं',
    ...
    weeklyScheduleDesc: 'सप्ताह के प्रत्येक दिन के लिए कार्य समय कॉन्फ़िगर करें',
    ...
    priorityRequired: 'प्राथमिकता आवश्यक है',
    ...
    investorNationalId: 'आईडी (राष्ट्रीय/इकामा)',
    enterNationalId: 'आईडी नंबर दर्ज करें',
    investorContactNumber: 'संपर्क नंबर',
    ...
    statementPreviewFailed: 'पूर्वावलोकन विफल',
    previewStatementDesc: 'नीचे निवेशक विवरण पीडीएफ का पूर्वावलोकन करें',
    investorType: 'Investor Type',
    selectInvestorType: 'Select investor type',
    moneyInvestor: 'Money Investor',
    recipeOwner: 'Recipe Owner',
    ...
    ibanAccount: 'IBAN खाता',
    ibanHelp: 'सऊदी IBAN प्रारूप: SA के बाद 22 अंक',
    ibanCertificate: 'IBAN सर्टिफिकेट',
    ibanCertUploaded: 'IBAN सर्टिफिकेट अपलोड हो गया',
    ibanCertUploadedDesc: 'IBAN सर्टिफिकेट सफलतापूर्वक अपलोड हो गया।',
    failedToUploadIbanCert: 'IBAN सर्टिफिकेट अपलोड करने में विफल',
    ibanCertDeleted: 'IBAN सर्टिफिकेट हटा दिया गया',
    ibanCertDeletedDesc: 'IBAN सर्टिफिकेट सफलतापूर्वक हटा दिया गया।',
    failedToDeleteIbanCert: 'IBAN सर्टिफिकेट हटाने में विफल',
    ibanCertPreviewFailed: 'IBAN सर्टिफिकेट का पूर्वावलोकन नहीं कर सके।',
    ibanCertDownloadFailed: 'IBAN सर्टिफिकेट डाउनलोड नहीं कर सके।',
    previewIbanCert: 'IBAN सर्टिफिकेट का पूर्वावलोकन करें',
    downloadIbanCert: 'IBAN सर्टिफिकेट डाउनलोड करें',
    uploadIbanCert: 'सर्टिफिकेट अपलोड करें',
    confirmDeleteIbanCert: 'IBAN सर्टिफिकेट हटाएं',
    confirmDeleteIbanCertDesc: 'क्या आप वाकई इस IBAN सर्टिफिकेट को हटाना चाहते हैं?',
    addSalary: 'वेतन जोड़ें',
    ...
    procurementDescription: 'इन्वेंट्री, रखरखाव, इंस्टॉलेशन और उपकरण खरीद का प्रबंधन करें',
    editProcurement: 'खरीद संपादित करें',
    newProcurementRequest: 'नई खरीद अनुरोध',
    newRequest: 'नया अनुरोध',
    installation: 'इंस्टॉलेशन',
    priority: 'प्राथमिकता',
    high: 'उच्च',
    linkToExistingInventory: 'मौजूदा इन्वेंट्री से लिंक करें (वैकल्पिक)',
    createNewInventoryItem: 'नया इन्वेंट्री आइटम बनाएं',
    title: 'शीर्षक',
    ...
    update: 'अपडेट',
    create: 'बनाएं',
    syncShopBills: 'दुकान के बिल सिंक करें',
    syncInventory: 'इन्वेंट्री सिंक करें',
    ...
    markAsOrdered: 'ऑर्डर किया गया चिह्नित करें',
    markAsReceived: 'प्राप्त चिह्नित करें',
    markAsCompleted: 'पूर्ण चिह्नित करें',
    deleteProcurementConfirm: 'क्या आप वाकई इस खरीद अनुरोध को हटाना चाहते हैं?',
    noProcurementFound: 'कोई खरीद अनुरोध नहीं मिला',
    failedToCreateProcurement: 'खरीद अनुरोध बनाने में विफल',
    failedToUpdateProcurement: 'खरीद अनुरोध अपडेट करने में विफल',
    failedToDeleteProcurement: 'खरीद अनुरोध हटाने में विफल',
    failedToReorderProcurement: 'पुनः ऑर्डर अनुरोध बनाने में विफल',
    failedToSyncInventory: 'इन्वेंट्री सिंक करने में विफल',
    failedToSyncShopBills: 'दुकान के बिल सिंक करने में विफल',
    shopBillsSynced: 'दुकान के बिल सिंक हो गए',
    inventorySynced: 'इन्वेंट्री आइटम खरीद में सिंक हो गए',
    dragDropOrClickToUpload: 'इनवॉइस अपलोड करने के लिए ड्रैग एंड ड्रॉप करें या क्लिक करें',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (अधिकतम 10MB)',
    automaticallyCalculated: 'स्वचालित रूप से गणना: कुल मूल्य ÷ मात्रा',
    totalPriceForEntireStock: 'संपूर्ण स्टॉक मात्रा का कुल मूल्य',
    expectedDelivery: 'अपेक्षित',
    reorderCreated: 'पुनः ऑर्डर अनुरोध सफलतापूर्वक बनाया गया',
  ...
  Urdu: {
    ...
    inventoryForecast: 'انوینٹری پیشن گوئی',
    inventoryForecastDesc: 'فروخت کی پیشن گوئی کی بنیاد پر متوقع انوینٹری ضروریات',
    noInventoryData: 'کوئی انوینٹری ڈیٹا دستیاب نہیں',
    linkRecipesToMenuItems: 'انوینٹری پیشن گوئی دیکھنے کے لیے ترکیبیں مینو آئٹمز سے لنک کریں',
    criticalStock: 'نازک اسٹاک',
    needsImmediateReorder: 'فوری دوبارہ آرڈر ضروری ہے',
    reorderSoon: 'جلد دوبارہ آرڈر کی سفارش کی جاتی ہے',
    sufficientStock: 'کافی اسٹاک',
    stockLevelOk: 'اسٹاک کی سطح مناسب ہے',
    inventoryItem: 'انوینٹری آئٹم',
    currentStock: 'موجودہ اسٹاک',
    requiredQuantity: 'مطلوبہ مقدار',
    shortfall: 'کمی',
    critical: 'نازک',
    low: 'کم',
    sufficient: 'کافی',
    showingTopInventory: 'کمی کے لحاظ سے سرفہرست {count} انوینٹری آئٹمز دکھا رہے ہیں',
    ...
    weeklyScheduleDesc: 'ہفتے کے ہر دن کے لیے کام کے اوقات ترتیب دیں',
    ...
    typeRequired: 'قسم ضروری ہے',
    titleRequired: 'عنوان ضروری ہے',
    statusRequired: 'حیثیت ضروری ہے',
    priorityRequired: 'ترجیح ضروری ہے',
    ...
    investorNationalId: 'شناخت (قومی/اقامہ)',
    enterNationalId: 'شناختی نمبر درج کریں',
    investorContactNumber: 'رابطہ نمبر',
    ...
    previewStatement: 'بیان کا پیش نظارہ',
    statementPreviewFailed: 'پیش نظارہ ناکام',
    previewStatementDesc: 'ذیل میں سرمایہ کار کے بیان کا پیش نظارہ کریں',
    investorType: 'Investor Type',
    selectInvestorType: 'Select investor type',
    moneyInvestor: 'Money Investor',
    recipeOwner: 'Recipe Owner',
    ...
    ibanAccount: 'IBAN اکاؤنٹ',
    ibanHelp: 'سعودی IBAN فارمیٹ: SA کے بعد 22 ہندسے',
    ibanCertificate: 'IBAN سرٹیفکیٹ',
    ibanCertUploaded: 'IBAN سرٹیفکیٹ اپ لوڈ ہو گیا',
    ibanCertUploadedDesc: 'IBAN سرٹیفکیٹ کامیابی سے اپ لوڈ ہو گیا۔',
    failedToUploadIbanCert: 'IBAN سرٹیفکیٹ اپ لوڈ کرنا ناکام',
    ibanCertDeleted: 'IBAN سرٹیفکیٹ حذف ہو گیا',
    ibanCertDeletedDesc: 'IBAN سرٹیفکیٹ کامیابی سے ہٹایا گیا۔',
    failedToDeleteIbanCert: 'IBAN سرٹیفکیٹ حذف کرنا ناکام',
    ibanCertPreviewFailed: 'IBAN سرٹیفکیٹ کا پیش نظارہ نہیں کر سکے۔',
    ibanCertDownloadFailed: 'IBAN سرٹیفکیٹ ڈاؤن لوڈ نہیں کر سکے۔',
    previewIbanCert: 'IBAN سرٹیفکیٹ کا پیش نظارہ کریں',
    downloadIbanCert: 'IBAN سرٹیفکیٹ ڈاؤن لوڈ کریں',
    uploadIbanCert: 'سرٹیفکیٹ اپ لوڈ کریں',
    confirmDeleteIbanCert: 'IBAN سرٹیفکیٹ حذف کریں',
    confirmDeleteIbanCertDesc: 'کیا آپ واقعی اس IBAN سرٹیفکیٹ کو حذف کرنا چاہتے ہیں؟',
    addSalary: 'تنخواہ شامل کریں',
    ...
    // Procurement Page Keys
    procurementManagement: 'خریداری کا انتظام',
    procurementDescription: 'انوینٹری، دیکھ بھال، تنصیبات اور آلات کی خریداری کا انتظام کریں',
    editProcurement: 'خریداری میں ترمیم کریں',
    newProcurementRequest: 'نئی خریداری کی درخواست',
    newRequest: 'نئی درخواست',
    installation: 'تنصیب',
    priority: 'ترجیح',
    high: 'زیادہ',
    linkToExistingInventory: 'موجودہ انوینٹری سے لنک کریں (اختیاری)',
    createNewInventoryItem: 'نئی انوینٹری آئٹم بنائیں',
    title: 'عنوان',
    ...
    update: 'اپڈیٹ',
    create: 'بنائیں',
    syncShopBills: 'دکان کے بل سنک کریں',
    syncInventory: 'انوینٹری سنک کریں',
    syncing: 'سنک ہو رہا ہے...',
    totalRequests: 'کل درخواستیں',
    inProgress: 'جاری',
    procurementRequests: 'خریداری کی درخواستیں',
    filterByStatus: 'حیثیت کے مطابق فلٹر کریں',
    allStatuses: 'تمام حیثیتیں',
    approve: 'منظور کریں',
    markAsOrdered: 'آرڈر شدہ کے طور پر نشان زد کریں',
    markAsReceived: 'موصول کے طور پر نشان زد کریں',
    markAsCompleted: 'مکمل کے طور پر نشان زد کریں',
    deleteProcurementConfirm: 'کیا آپ واقعی اس خریداری کی درخواست کو حذف کرنا چاہتے ہیں؟',
    noProcurementFound: 'کوئی خریداری کی درخواست نہیں ملی',
    failedToCreateProcurement: 'خریداری کی درخواست بنانے میں ناکام',
    failedToUpdateProcurement: 'خریداری کی درخواست اپڈیٹ کرنے میں ناکام',
    failedToDeleteProcurement: 'خریداری کی درخواست حذف کرنے میں ناکام',
    failedToReorderProcurement: 'دوبارہ آرڈر کی درخواست بنانے میں ناکام',
    failedToSyncInventory: 'انوینٹری سنک کرنے میں ناکام',
    failedToSyncShopBills: 'دکان کے بل سنک کرنے میں ناکام',
    shopBillsSynced: 'دکان کے بل سنک ہو گئے',
    inventorySynced: 'انوینٹری آئٹمز خریداری میں سنک ہو گئے',
    dragDropOrClickToUpload: 'انوائس اپلوڈ کرنے کے لیے ڈریگ اور ڈراپ کریں یا کلک کریں',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (زیادہ سے زیادہ 10MB)',
    automaticallyCalculated: 'خود بخود حساب: کل قیمت ÷ مقدار',
    totalPriceForEntireStock: 'پوری اسٹاک مقدار کی کل قیمت',
    expectedDelivery: 'متوقع',
    reorderCreated: 'دوبارہ آرڈر کی درخواست کامیابی سے بنائی گئی',
  ...
  Spanish: {
    ...
    inventoryForecastDesc: 'Requisitos de inventario previstos basados en el pronóstico de ventas',
    noInventoryData: 'No hay datos de inventario disponibles',
    linkRecipesToMenuItems: 'Vincula recetas a artículos del menú para ver pronósticos de inventario',
    criticalStock: 'Stock Crítico',
    needsImmediateReorder: 'Necesita reorden inmediato',
    reorderSoon: 'Se recomienda reordenar pronto',
    sufficientStock: 'Stock Suficiente',
    stockLevelOk: 'Niveles de stock adecuados',
    ...
    showingTopInventory: 'Mostrando los {count} principales artículos por déficit',
    performanceAnalysis: "Performance Analysis",
    performanceAnalysisDesc: "Compare sales across different time periods",
    dod: "Day-over-Day (DoD)",
    wow: "Week-over-Week (WoW)",
    ...
    weeklyScheduleDesc: 'Configurar horarios de operación para cada día de la semana',
    ...
    investorName: "Investor Name",
    enterInvestorName: "Enter investor name",
    investorNationalId: 'ID (Nacional/Iqama)',
    enterNationalId: 'Ingrese número de ID',
    investorContactNumber: 'Número de Contacto',
    enterContactNumber: 'Ingrese número de contacto',
    amountInvested: "Amount Invested",
    interestPercentage: "Interest Percentage",
    monthlyEarnings: "Monthly Earnings",
    netProfitSummary: "Net Profit Summary",
    ...
    statementDownloaded: "Statement downloaded successfully",
    statementDownloadFailed: "Failed to download statement",
    previewStatement: "Vista Previa del Estado",
    statementPreviewFailed: "Vista Previa Fallida",
    previewStatementDesc: "Previsualice el estado de cuenta del inversor a continuación",
    investorType: "Investor Type",
    selectInvestorType: "Select investor type",
    moneyInvestor: "Money Investor",
    recipeOwner: "Recipe Owner",
    ...
    ibanHelp: 'Formato IBAN saudí: SA seguido de 22 dígitos',
    ibanCertificate: 'Certificado IBAN',
    ibanCertUploaded: 'Certificado IBAN cargado',
    ibanCertUploadedDesc: 'El certificado IBAN se ha cargado correctamente.',
    failedToUploadIbanCert: 'Error al cargar el certificado IBAN',
    ibanCertDeleted: 'Certificado IBAN eliminado',
    ibanCertDeletedDesc: 'El certificado IBAN se ha eliminado correctamente.',
    failedToDeleteIbanCert: 'Error al eliminar el certificado IBAN',
    ibanCertPreviewFailed: 'No se pudo obtener una vista previa del certificado IBAN.',
    ibanCertDownloadFailed: 'No se pudo descargar el certificado IBAN.',
    previewIbanCert: 'Vista previa del certificado IBAN',
    downloadIbanCert: 'Descargar certificado IBAN',
    uploadIbanCert: 'Cargar certificado',
    confirmDeleteIbanCert: 'Eliminar certificado IBAN',
    confirmDeleteIbanCertDesc: '¿Está seguro de que desea eliminar este certificado IBAN?',
    addSalary: "Add Salary",
    editSalary: "Edit Salary",
    salaryFormDescription: "Enter employee salary information",
    totalSalaries: "Total Salaries",
    ...
    procurementDescription: 'Gestionar inventario, mantenimiento, instalaciones y adquisición de equipos',
    editProcurement: 'Editar Adquisición',
    newProcurementRequest: 'Nueva Solicitud de Adquisición',
    newRequest: 'Nueva Solicitud',
    installation: 'Instalación',
    priority: 'Prioridad',
    high: 'Alta',
    linkToExistingInventory: 'Vincular a Inventario Existente (Opcional)',
    createNewInventoryItem: 'Crear Nuevo Artículo de Inventario',
    title: 'Título',
    ...
    update: 'Actualizar',
    create: 'Crear',
    syncShopBills: 'Sincronizar Facturas de Tienda',
    syncInventory: 'Sincronizar Inventario',
    syncing: 'Sincronizando...',
    totalRequests: 'Total de Solicitudes',
    inProgress: 'En Progreso',
    procurementRequests: 'Solicitudes de Adquisición',
    filterByStatus: 'Filtrar por estado',
    allStatuses: 'Todos los Estados',
    approve: 'Aprobar',
    markAsOrdered: 'Marcar como Pedido',
    markAsReceived: 'Marcar como Recibido',
    markAsCompleted: 'Marcar como Completado',
    deleteProcurementConfirm: '¿Está seguro de que desea eliminar esta solicitud de adquisición?',
    noProcurementFound: 'No se encontraron solicitudes de adquisición',
    failedToCreateProcurement: 'Error al crear la solicitud de adquisición',
    failedToUpdateProcurement: 'Error al actualizar la solicitud de adquisición',
    failedToDeleteProcurement: 'Error al eliminar la solicitud de adquisición',
    failedToReorderProcurement: 'Error al crear la solicitud de reorden',
    failedToSyncInventory: 'Error al sincronizar el inventario',
    failedToSyncShopBills: 'Error al sincronizar las facturas de la tienda',
    shopBillsSynced: 'Facturas de tienda sincronizadas',
    inventorySynced: 'Artículos de inventario sincronizados con adquisiciones',
    dragDropOrClickToUpload: 'Arrastre y suelte o haga clic para subir factura',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (máx 10MB)',
    automaticallyCalculated: 'Calculado automáticamente: Precio Total ÷ Cantidad',
    totalPriceForEntireStock: 'Precio total para toda la cantidad de stock',
    expectedDelivery: 'Esperado',
    reorderCreated: 'Solicitud de reorden creada exitosamente',
  ...
  Tagalog: {
    ...
    inventoryForecast: 'Prediksyon ng Imbentaryo',
    inventoryForecastDesc: 'Inaasahang pangangailangan sa imbentaryo batay sa hula ng benta',
    noInventoryData: 'Walang available na data ng imbentaryo',
    linkRecipesToMenuItems: 'I-link ang mga recipe sa mga item ng menu upang makita ang mga prediksyon ng imbentaryo',
    criticalStock: 'Kritikal na Stock',
    needsImmediateReorder: 'Kailangang mag-reorder kaagad',
    reorderSoon: 'Inirerekomenda ang mabilis na pag-reorder',
    sufficientStock: 'Sapat na Stock',
    stockLevelOk: 'Sapat ang antas ng stock',
    inventoryItem: 'Item ng Imbentaryo',
    currentStock: 'Kasalukuyang Stock',
    requiredQuantity: 'Kinakailangang Dami',
    shortfall: 'Kakulangan',
    critical: 'Kritikal',
    low: 'Mababa',
    sufficient: 'Sapat',
    showingTopInventory: 'Ipinapakita ang nangungunang {count} na item ng imbentaryo ayon sa kakulangan',
    performanceAnalysis: "Performance Analysis",
    performanceAnalysisDesc: "Compare sales across different time periods",
    dod: "Day-over-Day (DoD)",
    wow: "Week-over-Week (WoW)",
    ...
    weeklyScheduleDesc: 'I-configure ang oras ng operasyon para sa bawat araw ng linggo',
    ...
    noInvestorsFound: "No investors found",
    investorNationalId: 'ID (National/Iqama)',
    enterNationalId: 'Ilagay ang numero ng ID',
    investorContactNumber: 'Contact Number',
    ...
    statementDownloaded: "Statement downloaded successfully",
    statementDownloadFailed: "Failed to download statement",
    previewStatement: "I-preview ang Statement",
    statementPreviewFailed: "Nabigo ang Preview",
    previewStatementDesc: "I-preview ang statement ng investor sa ibaba",
    investorType: "Investor Type",
    selectInvestorType: "Select investor type",
    moneyInvestor: "Money Investor",
    recipeOwner: "Recipe Owner",
    ...
    ibanAccount: 'IBAN Account',
    ibanHelp: 'Saudi IBAN format: SA na sinusundan ng 22 digit',
    ibanCertificate: 'IBAN Sertipiko',
    ibanCertUploaded: 'IBAN Sertipiko ay Nag-upload',
    ibanCertUploadedDesc: 'Ang IBAN sertipiko ay matagumpay na na-upload.',
    failedToUploadIbanCert: 'Nabigong I-upload ang IBAN Sertipiko',
    ibanCertDeleted: 'IBAN Sertipiko ay Natanggal',
    ibanCertDeletedDesc: 'Ang IBAN sertipiko ay matagumpay na naalis.',
    failedToDeleteIbanCert: 'Nabigong Tanggalin ang IBAN Sertipiko',
    ibanCertPreviewFailed: 'Hindi makikita ang IBAN sertipiko.',
    ibanCertDownloadFailed: 'Hindi mabuksan ang IBAN sertipiko.',
    previewIbanCert: 'Preview ng IBAN Sertipiko',
    downloadIbanCert: 'I-download ang IBAN Sertipiko',
    uploadIbanCert: 'I-upload ang Sertipiko',
    confirmDeleteIbanCert: 'Tanggalin ang IBAN Sertipiko',
    confirmDeleteIbanCertDesc: 'Sigurado ka bang gusto mong tanggalin ang IBAN sertipikong ito?',
    addSalary: "Add Salary",
    editSalary: "Edit Salary",
    salaryFormDescription: "Enter employee salary information",
    totalSalaries: "Total Salaries",
    ...
    // Procurement Page Keys
    procurementManagement: 'Pamamahala ng Pagkuha',
    procurementDescription: 'Pamahalaan ang imbentaryo, pagpapanatili, pag-install, at pagkuha ng kagamitan',
    editProcurement: 'I-edit ang Pagkuha',
    newProcurementRequest: 'Bagong Kahilingan ng Pagkuha',
    newRequest: 'Bagong Kahilingan',
    installation: 'Pag-install',
    priority: 'Prayoridad',
    high: 'Mataas',
    linkToExistingInventory: 'I-link sa Umiiral na Imbentaryo (Opsyonal)',
    createNewInventoryItem: 'Lumikha ng Bagong Aytem ng Imbentaryo',
    title: 'Pamagat',
    ...
    update: 'I-update',
    create: 'Lumikha',
    syncShopBills: 'I-sync ang Mga Bill ng Tindahan',
    syncInventory: 'I-sync ang Imbentaryo',
    syncing: 'Nagsi-sync...',
    totalRequests: 'Kabuuang Kahilingan',
    inProgress: 'Kasalukuyang Ginagawa',
    procurementRequests: 'Mga Kahilingan ng Pagkuha',
    filterByStatus: 'I-filter ayon sa status',
    allStatuses: 'Lahat ng Status',
    approve: 'Aprubahan',
    markAsOrdered: 'Markahan bilang Nai-order',
    markAsReceived: 'Markahan bilang Natanggap',
    markAsCompleted: 'Markahan bilang Nakumpleto',
    deleteProcurementConfirm: 'Sigurado ka bang gusto mong tanggalin ang kahilingang ito ng pagkuha?',
    noProcurementFound: 'Walang nahanap na mga kahilingan ng pagkuha',
    failedToCreateProcurement: 'Nabigong lumikha ng kahilingan ng pagkuha',
    failedToUpdateProcurement: 'Nabigong i-update ang kahilingan ng pagkuha',
    failedToDeleteProcurement: 'Nabigong tanggalin ang kahilingan ng pagkuha',
    failedToReorderProcurement: 'Nabigong lumikha ng kahilingan ng muling pag-order',
    failedToSyncInventory: 'Nabigong i-sync ang imbentaryo',
    failedToSyncShopBills: 'Nabigong i-sync ang mga bill ng tindahan',
    shopBillsSynced: 'Na-sync ang mga bill ng tindahan',
    inventorySynced: 'Na-sync ang mga aytem ng imbentaryo sa pagkuha',
    dragDropOrClickToUpload: 'I-drag at i-drop o i-click upang mag-upload ng invoice',
    supportedFileTypes: 'JPEG, PNG, GIF, WebP, PDF (max 10MB)',
    automaticallyCalculated: 'Awtomatikong kinakalkula: Kabuuang Presyo ÷ Dami',
    totalPriceForEntireStock: 'Kabuuang presyo para sa buong dami ng stock',
    expectedDelivery: 'Inaasahan',
    reorderCreated: 'Matagumpay na nalikha ang kahilingan ng muling pag-order',
