...
export function AppSidebar() {
  ...
  const allOperations: MenuItem[] = [
    ...
    { title: (t as any).propertyManagement || "Property Management", url: "/real-estate", icon: Home, testId: "real-estate-dashboard", gradient: "from-emerald-500 to-teal-500", permission: 'propertyManagement', businessTypes: ['real_estate'] },
    { title: (t as any).rentalContracts || "Rental Contracts", url: "/real-estate/contracts", icon: Handshake, testId: "real-estate-contracts", gradient: "from-orange-500 to-red-500", permission: 'rentalContracts', businessTypes: ['real_estate'] },
    { title: (t as any).maintenance || "Maintenance", url: "/real-estate/maintenance", icon: ClipboardList, testId: "real-estate-maintenance", gradient: "from-blue-500 to-cyan-500", permission: 'maintenance', businessTypes: ['real_estate'] },
  ...
  const allManagement: MenuItem[] = [
    ...
    { title: (t as any).properties || "Properties", url: "/real-estate/properties", icon: Building2, testId: "real-estate-properties", gradient: "from-emerald-500 to-teal-500", permission: 'propertyManagement', businessTypes: ['real_estate'] },
    { title: (t as any).units || "Units", url: "/real-estate/units", icon: Home, testId: "real-estate-units", gradient: "from-blue-500 to-indigo-500", permission: 'propertyManagement', businessTypes: ['real_estate'] },
    { title: (t as any).tenants || "Tenants", url: "/real-estate/tenants", icon: UserCircle, testId: "real-estate-tenants", gradient: "from-purple-500 to-fuchsia-500", permission: 'tenants', businessTypes: ['real_estate'] },
  ...
  const allAnalytics: MenuItem[] = [
    ...
    { title: (t as any).rentalInvoices || "Rental Invoices", url: "/real-estate/invoices", icon: Receipt, testId: "real-estate-invoices", gradient: "from-violet-500 to-purple-500", permission: 'rentalInvoices', businessTypes: ['real_estate'] },
    { title: (t as any).rentalPayments || "Rental Payments", url: "/real-estate/payments", icon: DollarSign, testId: "real-estate-payments", gradient: "from-green-500 to-teal-500", permission: 'rentalPayments', businessTypes: ['real_estate'] },
    { title: (t as any).propertyExpenses || "Property Expenses", url: "/real-estate/expenses", icon: Receipt, testId: "real-estate-expenses", gradient: "from-rose-500 to-orange-500", permission: 'propertyExpenses', businessTypes: ['real_estate'] },
    { title: (t as any).propertyReports || "Property Reports", url: "/real-estate/reports", icon: BarChart3, testId: "real-estate-reports", gradient: "from-cyan-500 to-blue-500", permission: 'propertyReports', businessTypes: ['real_estate'] },
    { title: (t as any).accounting || "Accounting", url: "/real-estate/accounting", icon: Calculator, testId: "real-estate-accounting", gradient: "from-indigo-500 to-violet-500", permission: 'accounting', businessTypes: ['real_estate'] },
