...
export function AppSidebar() {
  ...
  const allManagement: MenuItem[] = [
    ...
    { title: (t as any).investmentAgreementTemplates || "Investment Agreement Templates", url: "/investment-agreement-templates", icon: FileText, testId: "investment-agreement-templates", gradient: "from-emerald-500 to-teal-500", permission: 'investors' },
