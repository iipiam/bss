...
export function AppSidebar() {
  ...
  const allOperations: MenuItem[] = [
    ...
    { title: (t as any).cateringContracts || "Catering Contracts", url: "/catering-contracts", icon: FileText, testId: "catering-contracts", gradient: "from-amber-500 to-orange-500", permission: 'orders', businessTypes: ['restaurant'] },
  ...
  const allAnalytics: MenuItem[] = [
    ...
    { title: t.marketing || "Marketing", url: "/marketing", icon: Megaphone, testId: "marketing", gradient: "from-fuchsia-500 to-violet-500", permission: 'reports' },
  ];
